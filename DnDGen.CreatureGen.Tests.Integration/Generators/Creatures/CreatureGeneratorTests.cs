...
namespace DnDGen.CreatureGen.Tests.Integration.Generators.Creatures
{
    ...
    public class CreatureGeneratorTests : IntegrationTests
    {
        ...
        [TestCase(CreatureConstants.Dragon_Red_Adult, CreatureConstants.Templates.Skeleton)]
        [TestCase(CreatureConstants.Dragon_Red_MatureAdult, CreatureConstants.Templates.Skeleton)]
        [TestCase(CreatureConstants.Dragon_Red_Old, CreatureConstants.Templates.Skeleton)]
        [TestCase(CreatureConstants.Dragon_Red_VeryOld, CreatureConstants.Templates.Skeleton)]
        [TestCase(CreatureConstants.Dragon_Red_Ancient, CreatureConstants.Templates.Skeleton)]
        [TestCase(CreatureConstants.Dragon_Red_Wyrm, CreatureConstants.Templates.Skeleton)]
        [TestCase(CreatureConstants.Dragon_Red_GreatWyrm, CreatureConstants.Templates.Skeleton)]
        ...
        [TestCase(CreatureConstants.Giant_Hill, CreatureConstants.Templates.Lycanthrope_Boar)]
