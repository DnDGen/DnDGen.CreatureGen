...
namespace DnDGen.CreatureGen.Tests.Integration.Tables.Helpers
{
    ...
    public class MeasurementHelperTests : IntegrationTests
    {
        ...
        [TestCase(CreatureConstants.Barghest, false)]
        [TestCase(CreatureConstants.Barghest_Greater, false)]
        [TestCase(CreatureConstants.Bat_Dire, false)]
        [TestCase(CreatureConstants.Bear_Brown, false)]
        [TestCase(CreatureConstants.Beholder, false)]
        [TestCase(CreatureConstants.Beholder_Gauth, false)]
        [TestCase(CreatureConstants.BlackPudding, false)]
        [TestCase(CreatureConstants.BlackPudding_Elder, true)]
        [TestCase(CreatureConstants.Centaur, false)]
        [TestCase(CreatureConstants.Cloaker, true)]
        [TestCase(CreatureConstants.Delver, false)]
        [TestCase(CreatureConstants.DisplacerBeast, false)]
        [TestCase(CreatureConstants.DisplacerBeast_PackLord, false)]
        [TestCase(CreatureConstants.Drider, false)]
        [TestCase(CreatureConstants.GelatinousCube, false)]
        [TestCase(CreatureConstants.Gorgon, false)]
        [TestCase(CreatureConstants.Gynosphinx, false)]
        [TestCase(CreatureConstants.HellHound, true)]
        [TestCase(CreatureConstants.HellHound_NessianWarhound, true)]
        [TestCase(CreatureConstants.Hieracosphinx, false)]
        [TestCase(CreatureConstants.Howler, false)]
        [TestCase(CreatureConstants.Human, true)]
        [TestCase(CreatureConstants.Lamia, false)]
        [TestCase(CreatureConstants.Lammasu, false)]
        [TestCase(CreatureConstants.LanternArchon, false)]
        [TestCase(CreatureConstants.Lillend, true)]
        [TestCase(CreatureConstants.Lion, false)]
        [TestCase(CreatureConstants.Lion_Dire, false)]
        //INFO: Even though Mariliths are longer than tall, they are considered tall creatures for space and reach
        [TestCase(CreatureConstants.Marilith, true)]
        [TestCase(CreatureConstants.Nightwing, false)]
        [TestCase(CreatureConstants.Octopus, true)]
        [TestCase(CreatureConstants.Octopus_Giant, true)]
        [TestCase(CreatureConstants.Owl, false)]
        [TestCase(CreatureConstants.Owl_Giant, false)]
        [TestCase(CreatureConstants.Owlbear, false)]
        [TestCase(CreatureConstants.Pegasus, false)]
        [TestCase(CreatureConstants.PrayingMantis_Giant, false)]
        [TestCase(CreatureConstants.Retriever, false)]
        //INFO: Even though Salamanders are longer than tall, they are considered tall creatures for space and reach
        [TestCase(CreatureConstants.Salamander_Flamebrother, true)]
        [TestCase(CreatureConstants.Salamander_Average, true)]
        [TestCase(CreatureConstants.Salamander_Noble, true)]
        [TestCase(CreatureConstants.ShamblingMound, true)]
        [TestCase(CreatureConstants.Snake_Constrictor, false)]
        [TestCase(CreatureConstants.Squid, true)]
        [TestCase(CreatureConstants.Squid_Giant, true)]
        [TestCase(CreatureConstants.UmberHulk, true)]
        [TestCase(CreatureConstants.UmberHulk_TrulyHorrid, true)]
        [TestCase(CreatureConstants.Wolf, false)]
        //INFO: Even though Yuan-ti Abominations are longer than tall, they are considered tall creatures for space and reach
