...
namespace DnDGen.CreatureGen.Tests.Integration.Tables.Creatures
{
    ...
    public class CreatureTypesTests : CollectionTests
    {
        ...
        [TestCase(CreatureConstants.AnimatedObject_Colossal_Flexible, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_MultipleLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_MultipleLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_Sheetlike, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_TwoLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_TwoLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_Wheels_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_Flexible, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_MultipleLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_MultipleLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_Sheetlike, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_TwoLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_TwoLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_Wheels_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Huge, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Huge_Flexible, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Huge_MultipleLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Huge_MultipleLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Huge_Sheetlike, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Huge_TwoLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Huge_TwoLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Huge_Wheels_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Huge_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Large, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Large_Flexible, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Large_MultipleLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Large_MultipleLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Large_Sheetlike, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Large_TwoLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Large_TwoLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Large_Wheels_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Large_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Medium, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Medium_Flexible, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Medium_MultipleLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Medium_MultipleLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Medium_Sheetlike, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Medium_TwoLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Medium_TwoLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Medium_Wheels_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Medium_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Small, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Small_Flexible, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Small_MultipleLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Small_MultipleLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Small_Sheetlike, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Small_TwoLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Small_TwoLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Small_Wheels_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Small_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_Flexible, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_MultipleLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_MultipleLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_Sheetlike, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_TwoLegs, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_TwoLegs_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_Wheels_Wooden, CreatureConstants.Types.Construct)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_Wooden, CreatureConstants.Types.Construct)]
