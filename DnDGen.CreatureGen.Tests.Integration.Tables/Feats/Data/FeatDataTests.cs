...
namespace DnDGen.CreatureGen.Tests.Integration.Tables.Feats.Data
{
    ...
    public class FeatDataTests : DataTests
    {
        ...
        protected override void PopulateIndices(IEnumerable<string> collection)
        {
            ...
            indices[DataIndexConstants.FeatData.RequiresNaturalArmorIndex] = "Natural Armor";
            indices[DataIndexConstants.FeatData.RequiresSpecialAttackIndex] = "Special Attack";
            indices[DataIndexConstants.FeatData.RequiresSpellLikeAbilityIndex] = "Spell-Like Ability";
            indices[DataIndexConstants.FeatData.RequiresEquipmentIndex] = "Requires Equipment";
        }
            ...
            bool equipment)
        {
            ...
            data[DataIndexConstants.FeatData.RequiresNaturalArmorIndex] = Convert.ToString(naturalArmor);
            data[DataIndexConstants.FeatData.RequiresSpecialAttackIndex] = Convert.ToString(specialAttacks);
            data[DataIndexConstants.FeatData.RequiresSpellLikeAbilityIndex] = Convert.ToString(spellLikeAbility);
            data[DataIndexConstants.FeatData.RequiresEquipmentIndex] = Convert.ToString(equipment);
