        ...
        public static IEnumerable Creatures
        {
            get
            {
                ...
                testCases[CreatureConstants.Aasimar].Add(attackHelper.BuildData("Unarmed Strike",
                    damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning),
                ...
                testCases[CreatureConstants.Achaierai].Add(attackHelper.BuildData("Claw",
                    damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing),
                    string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Achaierai].Add(attackHelper.BuildData("Bite",
                    damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Piercing),
                    string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Achaierai].Add(attackHelper.BuildData("Black cloud",
                    damageHelper.BuildEntry("2d6", "Toxic black cloud"),
                ...
                testCases[CreatureConstants.Allip].Add(attackHelper.BuildData("Madness",
                    damageHelper.BuildEntry("1d4", AbilityConstants.Wisdom),
                    string.Empty, 0, "supernatural ability", 1, FeatConstants.Frequencies.Round, false, true, false, true));
                ...
                testCases[CreatureConstants.Androsphinx].Add(attackHelper.BuildData("Claw",
                    damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Slashing),
                    string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Angel_AstralDeva].Add(attackHelper.BuildData("Slam",
                    damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning),
                    string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Angel_Planetar].Add(attackHelper.BuildData("Slam",
                    damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning),
                    string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Anvil_Small].Add(attackHelper.BuildData("Slam",
                    damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning),
                    string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Anvil_Huge].Add(attackHelper.BuildData("Slam",
                    damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning),
                    string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Anvil_Colossal].Add(attackHelper.BuildData("Slam",
                    damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning),
                    string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Block_Stone_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Block_Stone_Colossal].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));
                ...
                testCases[CreatureConstants.AnimatedObject_Clothes_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Clothes_Tiny].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Clothes_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Clothes_Small].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Clothes_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Clothes_Medium].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Clothes_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Clothes_Large].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Clothes_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Clothes_Huge].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Clothes_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Clothes_Gargantuan].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Clothes_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Clothes_Colossal].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Ladder_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Ladder_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Ladder_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Ladder_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Ladder_Large].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Ladder_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Ladder_Huge].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Ladder_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Ladder_Gargantuan].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Ladder_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Ladder_Colossal].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rope_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Rope_Tiny].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rope_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Rope_Small].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rope_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Rope_Medium].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rope_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Rope_Large].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rope_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Rope_Huge].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rope_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Rope_Gargantuan].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rope_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Rope_Colossal].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rug_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Rug_Tiny].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rug_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Rug_Small].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rug_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Rug_Medium].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rug_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Rug_Large].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rug_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Rug_Huge].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rug_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Rug_Gargantuan].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Rug_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Rug_Colossal].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Sled_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Sled_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Sled_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Sled_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Sled_Large].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Sled_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Sled_Huge].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Sled_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Sled_Gargantuan].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Sled_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Sled_Colossal].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Large].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Huge].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Gargantuan].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Statue_Animal_Colossal].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Large].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Huge].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Gargantuan].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Statue_Humanoid_Colossal].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Stool_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Stool_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Stool_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Stool_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Stool_Large].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Stool_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Stool_Huge].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Stool_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Stool_Gargantuan].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Stool_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Stool_Colossal].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Table_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Table_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Table_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Table_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Table_Large].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Table_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Table_Huge].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Table_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Table_Gargantuan].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Table_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Table_Colossal].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Tapestry_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Tapestry_Tiny].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Tapestry_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Tapestry_Small].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Tapestry_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Tapestry_Medium].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Tapestry_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Tapestry_Large].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Tapestry_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Tapestry_Huge].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Tapestry_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Tapestry_Gargantuan].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Tapestry_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.AnimatedObject_Tapestry_Colossal].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Wagon_Tiny].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Wagon_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Wagon_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Wagon_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Wagon_Large].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Wagon_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Wagon_Huge].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Wagon_Gargantuan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Wagon_Gargantuan].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.AnimatedObject_Wagon_Colossal].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AnimatedObject_Wagon_Colossal].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));
                ...
                testCases[CreatureConstants.Ankheg].Add(attackHelper.BuildData("Spit Acid",
                    damageHelper.BuildEntry("4d4", FeatConstants.Foci.Elements.Acid),
                    string.Empty, 0, "extraordinary ability", 1, $"6 {FeatConstants.Frequencies.Hour}", false, true, true, true));

                testCases[CreatureConstants.Annis].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Annis].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Annis].Add(attackHelper.BuildData("Rake", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "extraordinary ability", 2, FeatConstants.Frequencies.Round, true, true, true, true));
                testCases[CreatureConstants.Annis].Add(attackHelper.BuildData("Rend", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Ant_Giant_Worker].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Ant_Giant_Soldier].Add(attackHelper.BuildData("Bite",
                    damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Piercing),
                    string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Ant_Giant_Queen].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Ape].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Ape].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));

                testCases[CreatureConstants.Ape_Dire].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Ape_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Ape_Dire].Add(attackHelper.BuildData("Rend", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.Aranea].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), "poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Arrowhawk_Juvenile].Add(attackHelper.BuildData("Electricity ray",
                    damageHelper.BuildEntry("2d6", FeatConstants.Foci.Elements.Electricity),
                ...
                testCases[CreatureConstants.Arrowhawk_Adult].Add(attackHelper.BuildData("Bite",
                    damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing),
                    string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Arrowhawk_Adult].Add(attackHelper.BuildData("Electricity ray",
                    damageHelper.BuildEntry("2d8", FeatConstants.Foci.Elements.Electricity),
                    string.Empty, 0, "ranged touch, supernatural ability", 1, FeatConstants.Frequencies.Round, false, true, true, true));

                testCases[CreatureConstants.Arrowhawk_Elder].Add(attackHelper.BuildData("Bite",
                    damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing),
                    string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Arrowhawk_Elder].Add(attackHelper.BuildData("Electricity ray",
                    damageHelper.BuildEntry("2d8", FeatConstants.Foci.Elements.Electricity),
                    string.Empty, 0, "ranged touch, supernatural ability", 1, FeatConstants.Frequencies.Round, false, true, true, true));

                testCases[CreatureConstants.AssassinVine].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.AssassinVine].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));
                ...
                testCases[CreatureConstants.Athach].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), "poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Athach].Add(attackHelper.BuildData("Rock", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "ranged", 1, FeatConstants.Frequencies.Round, false, true, true, false));
                testCases[CreatureConstants.Athach].Add(attackHelper.BuildData("Rock", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "ranged", 2, FeatConstants.Frequencies.Round, false, true, false, false));
                ...
                testCases[CreatureConstants.Avoral].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Avoral].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Azer].Add(attackHelper.BuildData("Heat",
                    damageHelper.BuildEntry("1", FeatConstants.Foci.Elements.Fire),
                    string.Empty, 0, "extraordinary ability", 1, FeatConstants.Frequencies.Hit, true, true, false, true));

                testCases[CreatureConstants.Babau].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Babau].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Babau].Add(attackHelper.BuildData("Sneak Attack", damageHelper.BuildEntry("2d6", string.Empty), string.Empty, 0, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Baboon].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Badger].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d2", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Badger].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Badger_Dire].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Badger_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Balor].Add(attackHelper.BuildData("Slam",
                    damageHelper.BuildEntry("1d10", AttributeConstants.DamageTypes.Bludgeoning),
                    string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Balor].Add(attackHelper.BuildData("Death Throes",
                    damageHelper.BuildEntry("100", string.Empty),
                ...
                testCases[CreatureConstants.BarbedDevil_Hamatula].Add(attackHelper.BuildData("Claw",
                    damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing),
                ...
                testCases[CreatureConstants.BarbedDevil_Hamatula].Add(attackHelper.BuildData("Impale",
                    damageHelper.BuildEntry("3d8", AttributeConstants.DamageTypes.Piercing),
                ...
                testCases[CreatureConstants.Barghest].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Barghest].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Barghest_Greater].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Barghest_Greater].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Basilisk].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Basilisk_Greater].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Bat_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Bat_Swarm].Add(attackHelper.BuildData("Swarm", damageHelper.BuildEntry("1d6", string.Empty), string.Empty, 0, "swarm", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Bear_Black].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Bear_Black].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));

                testCases[CreatureConstants.Bear_Brown].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Bear_Brown].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Bear_Dire].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Bear_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Bear_Polar].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Bear_Polar].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.BeardedDevil_Barbazu].Add(attackHelper.BuildData("Infernal Wound",
                    damageHelper.BuildEntry("2", string.Empty),
                ...
                testCases[CreatureConstants.BeardedDevil_Barbazu].Add(attackHelper.BuildData("Beard",
                    damageHelper.BuildEntry("1d8", string.Empty),
                ...
                testCases[CreatureConstants.Bebilith].Add(attackHelper.BuildData("Claw",
                    damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing),
                ...
                testCases[CreatureConstants.Bebilith].Add(attackHelper.BuildData("Rend Armor",
                    damageHelper.BuildEntry("4d6", string.Empty),
                ...
                testCases[CreatureConstants.Bee_Giant].Add(attackHelper.BuildData("Sting", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Life, true, true, true, false));
                ...
                testCases[CreatureConstants.Behir].Add(attackHelper.BuildData("Breath Weapon",
                    damageHelper.BuildEntry("7d6", FeatConstants.Foci.Elements.Electricity),
                ...
                testCases[CreatureConstants.Beholder].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Piercing), string.Empty, .5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Beholder_Gauth].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, .5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.BlackPudding].Add(attackHelper.BuildData("Slam", "2d6", "2d6 acid", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.BlackPudding].Add(attackHelper.BuildData("Constrict", "2d6", "2d6 acid", 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.BlackPudding_Elder].Add(attackHelper.BuildData("Slam", "3d6", "3d6 acid", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.BlackPudding_Elder].Add(attackHelper.BuildData("Constrict", "3d6", "3d6 acid", 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.BlinkDog].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Bodak].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.BoneDevil_Osyluth].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.BoneDevil_Osyluth].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Bralani].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Bugbear].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Bulette].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Bulette].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Cat].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d2", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Cat].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Centipede_Monstrous_Tiny].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Centipede_Monstrous_Medium].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Centipede_Monstrous_Large].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Centipede_Monstrous_Huge].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Centipede_Monstrous_Gargantuan].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.ChainDevil_Kyton].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Cheetah].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Cheetah].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d2", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Chimera_Black].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Chimera_Black].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Chimera_Black].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Chimera_Blue].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Chimera_Blue].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Chimera_Blue].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Chimera_Green].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Chimera_Green].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Chimera_Green].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Chimera_Red].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Chimera_Red].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Chimera_Red].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Chimera_White].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Chimera_White].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Chimera_White].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Choker].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));

                testCases[CreatureConstants.Chuul].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Couatl].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Couatl].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Criosphinx].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Criosphinx].Add(attackHelper.BuildData("Rake", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.Crocodile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Crocodile_Giant].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Darkmantle].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Darkmantle].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Deinonychus].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Delver].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), "2d6 acid", 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Destrachan].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Devourer].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Digester].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.DisplacerBeast].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.DisplacerBeast_PackLord].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));

                testCases[CreatureConstants.Djinni].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Djinni_Noble].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Dog_Riding].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Doppelganger].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.DragonTurtle].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //small
                testCases[CreatureConstants.Dragon_Black_VeryYoung].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Black_VeryYoung].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Black_Young].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Black_Young].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Black_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Black_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Black_YoungAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Black_YoungAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Black_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Black_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Black_MatureAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Black_MatureAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Black_Old].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Black_Old].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Black_VeryOld].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Black_VeryOld].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Black_Ancient].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Black_Ancient].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Black_Wyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Black_Wyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Black_GreatWyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Black_GreatWyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //small
                testCases[CreatureConstants.Dragon_Blue_Wyrmling].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Blue_Wyrmling].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Blue_VeryYoung].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Blue_VeryYoung].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Blue_Young].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Blue_Young].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Blue_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Blue_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Blue_YoungAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Blue_YoungAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Blue_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Blue_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Blue_MatureAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Blue_MatureAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Blue_Old].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Blue_Old].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Blue_VeryOld].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Blue_VeryOld].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Blue_Ancient].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Blue_Ancient].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Blue_Wyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Blue_Wyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Blue_GreatWyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Blue_GreatWyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //small
                testCases[CreatureConstants.Dragon_Green_Wyrmling].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Green_Wyrmling].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Green_VeryYoung].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Green_VeryYoung].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Green_Young].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Green_Young].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Green_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Green_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Green_YoungAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Green_YoungAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Green_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Green_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Green_MatureAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Green_MatureAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Green_Old].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Green_Old].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Green_VeryOld].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Green_VeryOld].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Green_Ancient].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Green_Ancient].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Green_Wyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Green_Wyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Green_GreatWyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Green_GreatWyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Red_Wyrmling].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Red_Wyrmling].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Red_VeryYoung].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Red_VeryYoung].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Red_Young].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Red_Young].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Red_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Red_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Red_YoungAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Red_YoungAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Red_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Red_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Red_MatureAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Red_MatureAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Red_Old].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Red_Old].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Red_VeryOld].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Red_VeryOld].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Red_Ancient].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Red_Ancient].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Red_Wyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Red_Wyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Red_GreatWyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //small
                testCases[CreatureConstants.Dragon_White_VeryYoung].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_White_VeryYoung].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_White_Young].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_White_Young].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_White_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_White_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_White_YoungAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_White_YoungAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_White_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_White_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_White_MatureAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_White_MatureAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_White_Old].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_White_Old].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_White_VeryOld].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_White_VeryOld].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_White_Ancient].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_White_Ancient].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_White_Wyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_White_Wyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_White_GreatWyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_White_GreatWyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //small
                testCases[CreatureConstants.Dragon_Brass_VeryYoung].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Brass_VeryYoung].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Brass_Young].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Brass_Young].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Brass_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Brass_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Brass_YoungAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Brass_YoungAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Brass_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Brass_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Brass_MatureAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Brass_MatureAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Brass_Old].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Brass_Old].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Brass_VeryOld].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Brass_VeryOld].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Brass_Ancient].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Brass_Ancient].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Brass_Wyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Brass_Wyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Brass_GreatWyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Brass_GreatWyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //small
                testCases[CreatureConstants.Dragon_Bronze_Wyrmling].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Bronze_Wyrmling].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Bronze_VeryYoung].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Bronze_VeryYoung].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Bronze_Young].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Bronze_Young].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Bronze_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Bronze_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Bronze_YoungAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Bronze_YoungAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Bronze_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Bronze_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Bronze_MatureAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Bronze_MatureAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Bronze_Old].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Bronze_Old].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Bronze_VeryOld].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Bronze_VeryOld].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Bronze_Ancient].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Bronze_Ancient].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Bronze_Wyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Bronze_Wyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Bronze_GreatWyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Bronze_GreatWyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //small
                testCases[CreatureConstants.Dragon_Copper_VeryYoung].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Copper_VeryYoung].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Copper_Young].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Copper_Young].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Copper_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Copper_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Copper_YoungAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Copper_YoungAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Copper_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Copper_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Copper_MatureAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Copper_MatureAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Copper_Old].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Copper_Old].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Copper_VeryOld].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Copper_VeryOld].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Copper_Ancient].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Copper_Ancient].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Copper_Wyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Copper_Wyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Copper_GreatWyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Copper_GreatWyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Gold_Wyrmling].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Gold_Wyrmling].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Gold_VeryYoung].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Gold_VeryYoung].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Gold_Young].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Gold_Young].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Gold_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Gold_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Gold_YoungAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Gold_YoungAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Gold_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Gold_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Gold_MatureAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Gold_MatureAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Gold_Old].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Gold_Old].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Gold_VeryOld].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Gold_VeryOld].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Gold_Ancient].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Gold_Ancient].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Gold_Wyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Gold_GreatWyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //small
                testCases[CreatureConstants.Dragon_Silver_Wyrmling].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Silver_Wyrmling].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Silver_VeryYoung].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Silver_VeryYoung].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //medium
                testCases[CreatureConstants.Dragon_Silver_Young].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Silver_Young].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Silver_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Silver_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //large
                testCases[CreatureConstants.Dragon_Silver_YoungAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Silver_YoungAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Silver_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Silver_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Silver_MatureAdult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Silver_MatureAdult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Silver_Old].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Silver_Old].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                //huge
                testCases[CreatureConstants.Dragon_Silver_VeryOld].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragon_Silver_VeryOld].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Silver_Ancient].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Silver_Ancient].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Silver_Wyrm].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Dragon_Silver_Wyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragon_Silver_GreatWyrm].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dragonne].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Dragonne].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Dretch].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Dryad].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Dwarf_Deep].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Dwarf_Duergar].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Dwarf_Hill].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Dwarf_Mountain].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Eagle_Giant].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Eagle_Giant].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));

                testCases[CreatureConstants.Efreeti].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), "Heat", 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elasmosaurus].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Elemental_Air_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Air_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Air_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Air_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Air_Greater].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Air_Elder].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Earth_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Earth_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Earth_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Fire_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), "Burn", 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Fire_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), "Burn", 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Fire_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), "Burn", 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Fire_Huge].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), "Burn", 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Fire_Greater].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), "Burn", 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Fire_Elder].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), "Burn", 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Water_Small].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Water_Medium].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elemental_Water_Large].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elephant].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elephant].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true, saveAbility: AbilityConstants.Strength, save: SaveConstants.Reflex));
                ...
                testCases[CreatureConstants.Elf_Aquatic].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elf_Drow].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elf_Gray].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elf_Half].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elf_High].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elf_Wild].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Elf_Wood].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Erinyes].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.EtherealMarauder].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Ettercap].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), "Poison", 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.FireBeetle_Giant].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.FormianWarrior].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.FormianTaskmaster].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.FormianMyrmarch].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.FrostWorm].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), "Cold", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Gargoyle].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Gargoyle].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Gargoyle_Kapoacinth].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Gargoyle_Kapoacinth].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.GelatinousCube].Add(attackHelper.BuildData("Slam", "1d6", "1d6 acid", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Ghoul].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), "Disease, Paralysis", 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Ghoul_Ghast].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), "Disease, Paralysis", 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Ghoul_Lacedon].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), "Disease, Paralysis", 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Giant_Cloud].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Giant_Cloud].Add(attackHelper.BuildData("Rock", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "ranged", 1, FeatConstants.Frequencies.Round, false, true, true, false));
                ...
                testCases[CreatureConstants.Giant_Fire].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Giant_Frost].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Giant_Hill].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Giant_Stone].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Giant_Stone].Add(attackHelper.BuildData("Rock", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "ranged", 1, FeatConstants.Frequencies.Round, false, true, true, false));
                ...
                testCases[CreatureConstants.Giant_Stone_Elder].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Giant_Stone_Elder].Add(attackHelper.BuildData("Rock", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "ranged", 1, FeatConstants.Frequencies.Round, false, true, true, false));
                ...
                testCases[CreatureConstants.Giant_Storm].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Girallon].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 4, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Girallon].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Githyanki].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Githzerai].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Glabrezu].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Glabrezu].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Gnoll].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Golem_Flesh].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.GrayRender].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.GrayRender].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.GrayRender].Add(attackHelper.BuildData("Rend", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));

                testCases[CreatureConstants.GreenHag].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Grick].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));

                testCases[CreatureConstants.Griffon].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Griffon].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Griffon].Add(attackHelper.BuildData("Rake", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "extraordinary ability", 2, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Grimlock].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Gynosphinx].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Gynosphinx].Add(attackHelper.BuildData("Rake", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "extraordinary ability", 2, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.HellHound].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), "Fiery Bite", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.HellHound_NessianWarhound].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), "Fiery Bite", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Hellcat_Bezekira].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Hellcat_Bezekira].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Hezrou].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Hieracosphinx].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Hieracosphinx].Add(attackHelper.BuildData("Rake", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "extraordinary ability", 2, FeatConstants.Frequencies.Round, true, true, false, true));

                testCases[CreatureConstants.Hippogriff].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Hippogriff].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Hobgoblin].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.HornedDevil_Cornugon].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.HornedDevil_Cornugon].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Horse_Light_War].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.HoundArchon].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.HoundArchon].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Howler].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), "1d4 Quills", 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Human].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Hyena].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.IceDevil_Gelugon].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Imp].Add(attackHelper.BuildData("Sting", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Piercing), "poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.InvisibleStalker].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Janni].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Kolyarut].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Krenshar].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Krenshar].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.KuoToa].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Lamia].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Lammasu].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Lammasu].Add(attackHelper.BuildData("Rake", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "extraordinary ability", 2, FeatConstants.Frequencies.Round, true, true, true, true));
                ...
                testCases[CreatureConstants.Lemure].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Leonal].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Leonal].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Leonal].Add(attackHelper.BuildData("Rake", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "extraordinary ability", 2, FeatConstants.Frequencies.Round, true, true, true, true));
                ...
                testCases[CreatureConstants.Leopard].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Lillend].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Lion].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Lion].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Lion_Dire].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Lion_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Lion_Dire].Add(attackHelper.BuildData("Rake", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "extraordinary ability", 2, FeatConstants.Frequencies.Round, true, true, true, true));
                ...
                testCases[CreatureConstants.Lizard_Monitor].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Lizardfolk].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Locathah].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Magmin].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), "Combustion", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Manticore].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Manticore].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Marilith].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 6, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Marilith].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("4d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true, SaveConstants.Fortitude, AbilityConstants.Strength));
                ...
                testCases[CreatureConstants.Marut].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), "Fist of Thunder", 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Marut].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), "Fist of Lightning", 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Megaraptor].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Merfolk].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Mimic].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Mohrg].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Monkey].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Mummy].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), "Disease", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Naga_Guardian].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Naga_Spirit].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Naga_Water].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Nalfeshnee].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Nalfeshnee].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.NightHag].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), "Disease", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Nightmare].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Nightmare_Cauchemar].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Nightwalker].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Nightwing].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), "Magic Drain", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Nymph].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Octopus].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Octopus_Giant].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Octopus_Giant].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Orc].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Orc_Half].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Otyugh].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Owl_Giant].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Owl_Giant].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));

                testCases[CreatureConstants.Owlbear].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Owlbear].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Pegasus].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.PhantomFungus].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.PhaseSpider].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Phasm].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.PitFiend].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.PitFiend].Add(attackHelper.BuildData("Wing", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.PitFiend].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 2, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.PrayingMantis_Giant].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.PurpleWorm].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Rakshasa].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Rakshasa].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Rast].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 4, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Rast].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Rat].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Rat_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), "Disease", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Rat_Swarm].Add(attackHelper.BuildData("Swarm", damageHelper.BuildEntry("1d6", string.Empty), "Disease", 0, "swarm", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Ravid].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), "Positive Energy", 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.RazorBoar].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Remorhaz].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Retriever].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 4, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Retriever].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Roc].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Roper].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Sahuagin_Malenti].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Salamander_Flamebrother].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), "Heat", 0.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Salamander_Average].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), "Heat", 0.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Salamander_Noble].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), "Heat", 0.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Tiny].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d2", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Small].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Medium].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Scorpion_Monstrous_Medium].Add(attackHelper.BuildData("Sting", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Piercing), "Poison", 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Scorpion_Monstrous_Medium].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Large].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Large].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Huge].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Huge].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Gargantuan].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Gargantuan].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Colossal].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Scorpion_Monstrous_Colossal].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Scorpionfolk].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Scorpionfolk].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true, saveAbility: AbilityConstants.Strength, save: SaveConstants.Reflex));

                testCases[CreatureConstants.SeaCat].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.SeaCat].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.SeaCat].Add(attackHelper.BuildData("Rend", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));

                testCases[CreatureConstants.SeaHag].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.ShadowMastiff].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.ShamblingMound].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.ShamblingMound].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Shark_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Shark_Huge].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Shark_Large].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Shark_Medium].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.ShieldGuardian].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Skum].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Skum].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Skum].Add(attackHelper.BuildData("Rake", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "extraordinary ability", 2, FeatConstants.Frequencies.Round, true, true, true, true));

                testCases[CreatureConstants.Slaad_Red].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Slaad_Red].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), "Implant", 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Slaad_Blue].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 4, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Slaad_Blue].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), "Disease", 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Slaad_Green].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Slaad_Green].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Slaad_Gray].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Slaad_Gray].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Snake_Constrictor].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Snake_Constrictor].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));

                testCases[CreatureConstants.Snake_Constrictor_Giant].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Snake_Constrictor_Giant].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.Snake_Viper_Tiny].Add(attackHelper.BuildData("Poison", string.Empty, "Initial and secondary damage 1d6 Con", 0, "extraordinary ability", 1, FeatConstants.Frequencies.Hit, true, true, false, true, SaveConstants.Fortitude, AbilityConstants.Constitution));
                ...
                testCases[CreatureConstants.Snake_Viper_Huge].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Spider_Monstrous_Hunter_Tiny].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Spider_Monstrous_Hunter_Medium].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Spider_Monstrous_Hunter_Large].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Spider_Monstrous_Hunter_Huge].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Spider_Monstrous_Hunter_Gargantuan].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Spider_Monstrous_WebSpinner_Tiny].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Spider_Monstrous_WebSpinner_Medium].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Spider_Monstrous_WebSpinner_Large].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Spider_Monstrous_WebSpinner_Huge].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Spider_Monstrous_WebSpinner_Gargantuan].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), "Poison", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.SpiderEater].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Spider_Swarm].Add(attackHelper.BuildData("Swarm", damageHelper.BuildEntry("1d6", string.Empty), "poison", 0, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Squid].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Squid_Giant].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Squid_Giant].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.StagBeetle_Giant].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 0.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true, saveAbility: AbilityConstants.Strength, save: SaveConstants.Reflex));
                ...
                testCases[CreatureConstants.Succubus].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Tendriculos].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Thoqqua].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), "Heat, Burn", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Tiefling].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Tiger].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Tiger].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Tiger_Dire].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Tiger_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Titan].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Tojanida_Juvenile].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Tojanida_Juvenile].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Tojanida_Adult].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Tojanida_Adult].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Tojanida_Elder].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Tojanida_Elder].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Treant].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Treant].Add(attackHelper.BuildData("Trample", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true, saveAbility: AbilityConstants.Strength, save: SaveConstants.Reflex));
                ...
                testCases[CreatureConstants.Triton].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Troglodyte].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Troll].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Troll].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Troll].Add(attackHelper.BuildData("Rend", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));

                testCases[CreatureConstants.Troll_Scrag].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Troll_Scrag].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                testCases[CreatureConstants.Troll_Scrag].Add(attackHelper.BuildData("Rend", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, false, true));
                ...
                testCases[CreatureConstants.TrumpetArchon].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.UmberHulk].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.UmberHulk].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.VampireSpawn].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), "Energy Drain", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Vrock].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Vrock].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Weasel].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Piercing), "Attach", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Weasel_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), "Attach", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Whale_Orca].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));

                testCases[CreatureConstants.Wight].Add(attackHelper.BuildData("Slam", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), "Energy Drain", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.WinterWolf].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), "Freezing Bite", 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Wolf].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Wolf_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Wolverine].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Wolverine].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Wolverine_Dire].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Wolverine_Dire].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 0.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Worg].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Piercing), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.Wyvern].Add(attackHelper.BuildData("Bite", damageHelper.BuildEntry("2d8", AttributeConstants.DamageTypes.Piercing), string.Empty, 1, "melee", 1, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Xill].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 1, "melee", 2, FeatConstants.Frequencies.Round, true, true, true, false));
                testCases[CreatureConstants.Xill].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Xorn_Average].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 3, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Xorn_Elder].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 3, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.Yrthak].Add(attackHelper.BuildData("Claw", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Slashing), string.Empty, 0.5, "melee", 2, FeatConstants.Frequencies.Round, true, true, false, false));
                ...
                testCases[CreatureConstants.YuanTi_Pureblood].Add(attackHelper.BuildData("Unarmed Strike", damageHelper.BuildEntry("1d3", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
                ...
                testCases[CreatureConstants.YuanTi_Halfblood_SnakeTailAndHumanLegs].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d4", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));
                ...
                testCases[CreatureConstants.YuanTi_Halfblood_SnakeTail].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));
                ...
                testCases[CreatureConstants.YuanTi_Abomination].Add(attackHelper.BuildData("Constrict", damageHelper.BuildEntry("1d6", AttributeConstants.DamageTypes.Bludgeoning), string.Empty, 1.5, "extraordinary ability", 1, FeatConstants.Frequencies.Round, true, true, true, true));
                ...
                testCases[CreatureConstants.Zelekhut].Add(attackHelper.BuildData("Unarmed Strike", "1d4", string.Empty, 1.5, "melee", 1, FeatConstants.Frequencies.Round, true, true, true, false));
