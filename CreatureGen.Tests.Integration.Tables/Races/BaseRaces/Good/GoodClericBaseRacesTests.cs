...
namespace CreatureGen.Tests.Integration.Tables.Races.BaseRaces.Good
{
    ...
    public class GoodClericBaseRacesTests : PercentileTests
    {
        ...
        [TestCase(22, 22, SizeConstants.BaseRaces.HoundArchon)]
        [TestCase(23, 24, SizeConstants.BaseRaces.MountainDwarf)]
        ...
        [TestCase(71, 95, SizeConstants.BaseRaces.Human)]
        [TestCase(96, 96, SizeConstants.BaseRaces.Pixie)]
        [TestCase(97, 97, SizeConstants.BaseRaces.Centaur)]
