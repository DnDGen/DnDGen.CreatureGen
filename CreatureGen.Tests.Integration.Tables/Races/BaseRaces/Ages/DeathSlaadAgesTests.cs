...
namespace CreatureGen.Tests.Integration.Tables.Races.BaseRaces.Ages
{
    ...
    public class DeathSlaadAgesTests : AdjustmentsTests
    {
        ...
        {
            get { return string.Format(TableNameConstants.Formattable.Adjustments.RACEAges, SizeConstants.BaseRaces.DeathSlaad); }
        }
        ...
        [TestCase(SizeConstants.Ages.Adulthood, 100)]
