...
namespace CreatureGen.Tests.Integration.Tables.Races.BaseRaces.Ages
{
    ...
    public class GreenSlaadAgesTests : AdjustmentsTests
    {
        ...
        {
            get { return string.Format(TableNameConstants.Formattable.Adjustments.RACEAges, SizeConstants.BaseRaces.GreenSlaad); }
        }
        ...
        [TestCase(SizeConstants.Ages.Adulthood, 1)]
