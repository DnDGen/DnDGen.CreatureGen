    ...
    public class AttackTestData
    {
        ...
        public static IEnumerable Creatures
        {
            get
            {
                ...
                testCases[CreatureConstants.AnimatedObject_Tiny].Add(AttackHelper.BuildData("Slam", $"1d3 + {AbilityConstants.Strength.ToUpper()}", true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Small].Add(AttackHelper.BuildData("Slam", $"1d4 + {AbilityConstants.Strength.ToUpper()}", true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Medium].Add(AttackHelper.BuildData("Slam", $"1d6 + {AbilityConstants.Strength.ToUpper()}", true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Large].Add(AttackHelper.BuildData("Slam", $"1d8 + {AbilityConstants.Strength.ToUpper()}", true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Huge].Add(AttackHelper.BuildData("Slam", $"2d6 + {AbilityConstants.Strength.ToUpper()}", true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Gargantuan].Add(AttackHelper.BuildData("Slam", $"2d8 + {AbilityConstants.Strength.ToUpper()}", true, true, true, false));

                testCases[CreatureConstants.AnimatedObject_Colossal].Add(AttackHelper.BuildData("Slam", $"4d6 + {AbilityConstants.Strength.ToUpper()}", true, true, true, false));
