...
namespace CreatureGen.Tests.Integration.Tables.Creatures
{
    ...
    public class CreatureDataTests : DataTests
    {
        ...
        [TestCase(CreatureConstants.Cryohydra_5Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Six, null, false)]
        [TestCase(CreatureConstants.Cryohydra_6Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Seven, null, false)]
        [TestCase(CreatureConstants.Cryohydra_7Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Eight, null, false)]
        [TestCase(CreatureConstants.Cryohydra_8Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Nine, null, false)]
        [TestCase(CreatureConstants.Cryohydra_9Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Ten, null, false)]
        [TestCase(CreatureConstants.Cryohydra_10Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Eleven, null, false)]
        [TestCase(CreatureConstants.Cryohydra_11Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Twelve, null, false)]
        [TestCase(CreatureConstants.Cryohydra_12Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Thirteen, null, false)]
        ...
        [TestCase(CreatureConstants.HornedDevil_Cornugon, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Sixteen, null, true)]
        ...
        [TestCase(CreatureConstants.Howler, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Human, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.OneHalf, 0, true)]
        [TestCase(CreatureConstants.Hydra_5Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Four, null, false)]
        [TestCase(CreatureConstants.Hydra_6Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Five, null, false)]
        [TestCase(CreatureConstants.Hydra_7Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Six, null, false)]
        [TestCase(CreatureConstants.Hydra_8Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Seven, null, false)]
        [TestCase(CreatureConstants.Hydra_9Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Eight, null, false)]
        [TestCase(CreatureConstants.Hydra_10Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Nine, null, false)]
        [TestCase(CreatureConstants.Hydra_11Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Ten, null, false)]
        [TestCase(CreatureConstants.Hydra_12Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Eleven, null, false)]
        [TestCase(CreatureConstants.Hyena, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.One, null, false)]
        [TestCase(CreatureConstants.IceDevil_Gelugon, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Thirteen, null, true)]
        [TestCase(CreatureConstants.Imp, SizeConstants.Tiny, 2.5, 0, ChallengeRatingConstants.Two, null, false)]
        ...
        [TestCase(CreatureConstants.Lamia, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Six, 4, true)]
        [TestCase(CreatureConstants.Lammasu, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Eight, 5, false)]
        ...
        [TestCase(CreatureConstants.Leonal, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Twelve, null, false)]
        [TestCase(CreatureConstants.Leopard, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, null, false)]
        [TestCase(CreatureConstants.Lillend, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Seven, 6, true)]
        ...
        [TestCase(CreatureConstants.Lizardfolk, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.One, 1, true)]
        [TestCase(CreatureConstants.Locathah, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.OneHalf, 1, true)]
        [TestCase(CreatureConstants.Locust_Swarm, SizeConstants.Diminutive, 10, 0, ChallengeRatingConstants.Three, null, false)]
        [TestCase(CreatureConstants.Magmin, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, null, false)]
        ...
        [TestCase(CreatureConstants.Mephit_Dust, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Mephit_Earth, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Mephit_Fire, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Mephit_Ice, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Mephit_Magma, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Mephit_Ooze, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Mephit_Salt, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Mephit_Steam, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Mephit_Water, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Merfolk, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.OneHalf, 1, true)]
        [TestCase(CreatureConstants.Mimic, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Four, null, false)]
        [TestCase(CreatureConstants.MindFlayer, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Eight, 7, true)]
        [TestCase(CreatureConstants.Minotaur, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Four, 2, true)]
        [TestCase(CreatureConstants.Mohrg, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Eight, null, false)]
        ...
        [TestCase(CreatureConstants.Mummy, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Five, 0, true)]
        [TestCase(CreatureConstants.Naga_Dark, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Eight, null, false)]
        [TestCase(CreatureConstants.Naga_Guardian, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Ten, null, false)]
        [TestCase(CreatureConstants.Naga_Spirit, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Nine, null, false)]
        [TestCase(CreatureConstants.Naga_Water, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Seven, null, false)]
        [TestCase(CreatureConstants.Nalfeshnee, SizeConstants.Huge, 15, 15, ChallengeRatingConstants.Fourteen, null, false)]
        [TestCase(CreatureConstants.NightHag, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Nine, null, false)]
        [TestCase(CreatureConstants.Nightcrawler, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.Eighteen, null, false)]
        [TestCase(CreatureConstants.Nightmare, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Five, 4, false)]
        [TestCase(CreatureConstants.Nightmare_Cauchemar, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Eleven, 4, false)]
        [TestCase(CreatureConstants.Nightwalker, SizeConstants.Huge, 15, 15, ChallengeRatingConstants.Sixteen, null, false)]
        [TestCase(CreatureConstants.Nightwing, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Fourteen, null, false)]
        [TestCase(CreatureConstants.Nixie, SizeConstants.Small, 5, 5, ChallengeRatingConstants.One, 3, true)]
        [TestCase(CreatureConstants.Nymph, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Seven, 7, true)]
        ...
        [TestCase(CreatureConstants.Ogre, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Three, 2, true)]
        [TestCase(CreatureConstants.Ogre_Merrow, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Three, 2, true)]
        [TestCase(CreatureConstants.OgreMage, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Eight, 7, true)]
        ...
        [TestCase(CreatureConstants.Otyugh, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Four, null, false)]
        [TestCase(CreatureConstants.Owl, SizeConstants.Tiny, 2.5, 0, ChallengeRatingConstants.OneFourth, null, false)]
        [TestCase(CreatureConstants.Owl_Giant, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Three, 2, false)]
        [TestCase(CreatureConstants.Owlbear, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Four, null, false)]
        [TestCase(CreatureConstants.Pegasus, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Three, 2, false)]
        [TestCase(CreatureConstants.PhantomFungus, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Three, null, false)]
        [TestCase(CreatureConstants.PhaseSpider, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Five, null, false)]
        [TestCase(CreatureConstants.Phasm, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Seven, null, false)]
        ...
        [TestCase(CreatureConstants.Pseudodragon, SizeConstants.Tiny, 2.5, 0, ChallengeRatingConstants.One, 3, false)]
        [TestCase(CreatureConstants.PurpleWorm, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.Twelve, null, false)]
        [TestCase(CreatureConstants.Pyrohydra_5Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Six, null, false)]
        [TestCase(CreatureConstants.Pyrohydra_6Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Seven, null, false)]
        [TestCase(CreatureConstants.Pyrohydra_7Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Eight, null, false)]
        [TestCase(CreatureConstants.Pyrohydra_8Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Nine, null, false)]
        [TestCase(CreatureConstants.Pyrohydra_9Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Ten, null, false)]
        [TestCase(CreatureConstants.Pyrohydra_10Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Eleven, null, false)]
        [TestCase(CreatureConstants.Pyrohydra_11Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Twelve, null, false)]
        [TestCase(CreatureConstants.Pyrohydra_12Heads, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Thirteen, null, false)]
        [TestCase(CreatureConstants.Quasit, SizeConstants.Tiny, 2.5, 0, ChallengeRatingConstants.Two, null, false)]
        [TestCase(CreatureConstants.Rakshasa, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Ten, 7, true)]
        [TestCase(CreatureConstants.Rast, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Five, null, false)]
        ...
        [TestCase(CreatureConstants.Ravid, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Five, null, false)]
        [TestCase(CreatureConstants.RazorBoar, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Ten, null, false)]
        [TestCase(CreatureConstants.Remorhaz, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Seven, null, false)]
        ...
        [TestCase(CreatureConstants.Roc, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.Nine, null, false)]
        [TestCase(CreatureConstants.Roper, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Twelve, null, false)]
        [TestCase(CreatureConstants.RustMonster, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Three, null, false)]
        [TestCase(CreatureConstants.Sahuagin, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, 2, true)]
        [TestCase(CreatureConstants.Sahuagin_Mutant, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, 3, true)]
        [TestCase(CreatureConstants.Sahuagin_Malenti, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, 2, true)]
        [TestCase(CreatureConstants.Salamander_Average, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Six, 5, true)]
        [TestCase(CreatureConstants.Salamander_Flamebrother, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, 4, true)]
        [TestCase(CreatureConstants.Salamander_Noble, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Ten, null, true)]
        [TestCase(CreatureConstants.Satyr, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, 2, true)]
        [TestCase(CreatureConstants.Satyr_WithPipes, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Four, 2, true)]
        ...
        [TestCase(CreatureConstants.Scorpionfolk, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Seven, 4, true)]
        [TestCase(CreatureConstants.SeaCat, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Four, null, false)]
        [TestCase(CreatureConstants.SeaHag, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Four, 0, true)]
        [TestCase(CreatureConstants.Shadow, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Three, null, false)]
        [TestCase(CreatureConstants.Shadow_Greater, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Eight, null, false)]
        [TestCase(CreatureConstants.ShadowMastiff, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Five, 3, false)]
        [TestCase(CreatureConstants.ShamblingMound, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Six, 6, false)]
        ...
        [TestCase(CreatureConstants.ShieldGuardian, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Eight, null, false)]
        [TestCase(CreatureConstants.ShockerLizard, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Two, null, false)]
        [TestCase(CreatureConstants.Shrieker, SizeConstants.Medium, 5, 0, ChallengeRatingConstants.One, null, false)]
        [TestCase(CreatureConstants.Skum, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, 3, true)]
        ...
        [TestCase(CreatureConstants.Spectre, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Seven, null, false)]
        ...
        [TestCase(CreatureConstants.SpiderEater, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Five, null, false)]
        ...
        [TestCase(CreatureConstants.Stirge, SizeConstants.Tiny, 2.5, 0, ChallengeRatingConstants.OneHalf, null, false)]
        [TestCase(CreatureConstants.Succubus, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Seven, 6, true)]
        [TestCase(CreatureConstants.Tarrasque, SizeConstants.Colossal, 30, 20, ChallengeRatingConstants.Twenty, null, false)]
        [TestCase(CreatureConstants.Tendriculos, SizeConstants.Huge, 15, 15, ChallengeRatingConstants.Six, null, false)]
        [TestCase(CreatureConstants.Thoqqua, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, null, false)]
        ...
        [TestCase(CreatureConstants.Titan, SizeConstants.Huge, 15, 15, ChallengeRatingConstants.TwentyOne, null, true)]
        [TestCase(CreatureConstants.Toad, SizeConstants.Diminutive, 1, 0, ChallengeRatingConstants.OneTenth, null, false)]
        [TestCase(CreatureConstants.Tojanida_Adult, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Five, null, false)]
        [TestCase(CreatureConstants.Tojanida_Elder, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Nine, null, false)]
        [TestCase(CreatureConstants.Tojanida_Juvenile, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, null, false)]
        [TestCase(CreatureConstants.Treant, SizeConstants.Huge, 15, 15, ChallengeRatingConstants.Eight, 5, false)]
        [TestCase(CreatureConstants.Triceratops, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Nine, null, false)]
        [TestCase(CreatureConstants.Triton, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, 2, true)]
        [TestCase(CreatureConstants.Troglodyte, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.One, 2, true)]
        [TestCase(CreatureConstants.Troll, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Five, 5, true)]
        [TestCase(CreatureConstants.Troll_Scrag, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Five, 5, true)]
        ...
        [TestCase(CreatureConstants.UmberHulk, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Seven, null, false)]
        [TestCase(CreatureConstants.UmberHulk_TrulyHorrid, SizeConstants.Huge, 15, 15, ChallengeRatingConstants.Fourteen, null, false)]
        [TestCase(CreatureConstants.Unicorn, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Three, 4, false)]
        [TestCase(CreatureConstants.VampireSpawn, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Four, null, false)]
        [TestCase(CreatureConstants.Vargouille, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Two, null, false)]
        ...
        [TestCase(CreatureConstants.Wight, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Three, null, false)]
        [TestCase(CreatureConstants.WillOWisp, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Six, null, false)]
        [TestCase(CreatureConstants.WinterWolf, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Five, 3, false)]
        ...
        [TestCase(CreatureConstants.Worg, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, 1, false)]
        [TestCase(CreatureConstants.Wraith, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Five, null, false)]
        [TestCase(CreatureConstants.Wraith_Dread, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Eleven, null, false)]
        [TestCase(CreatureConstants.Wyvern, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Six, null, false)]
        [TestCase(CreatureConstants.Xill, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Six, 4, true)]
        [TestCase(CreatureConstants.Xorn_Average, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Six, null, false)]
        [TestCase(CreatureConstants.Xorn_Elder, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Eight, null, false)]
        [TestCase(CreatureConstants.Xorn_Minor, SizeConstants.Small, 5, 5, ChallengeRatingConstants.Three, null, false)]
        [TestCase(CreatureConstants.YethHound, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Three, 3, false)]
        [TestCase(CreatureConstants.Yrthak, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Nine, null, false)]
