...
namespace CreatureGen.Tests.Integration.Tables.Creatures
{
    ...
    public class CreatureDataTests : DataTests
    {
        ...
        [TestCase(CreatureConstants.AnimatedObject_Colossal, SizeConstants.Colossal, 30, 20, ChallengeRatingConstants.Ten, null, false, 0, 12, 0)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.Seven, null, false, 0, 8, 0)]
        [TestCase(CreatureConstants.AnimatedObject_Huge, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Five, null, false, 0, 6, 0)]
        [TestCase(CreatureConstants.AnimatedObject_Large, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Three, null, false, 0, 5, 0)]
        [TestCase(CreatureConstants.AnimatedObject_Medium, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, null, false, 0, 4, 0)]
        [TestCase(CreatureConstants.AnimatedObject_Small, SizeConstants.Small, 5, 5, ChallengeRatingConstants.One, null, false, 0, 2, 0)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny, SizeConstants.Tiny, 2.5, 0, ChallengeRatingConstants.OneHalf, null, false, 0, 0, 0)]
        ...
        [TestCase(CreatureConstants.Avoral, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Nine, null, false, 8, 8, 2)]
        [TestCase(CreatureConstants.Azer, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Two, 4, true, 0, 6, 2)]
        [TestCase(CreatureConstants.Babau, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Six, null, false, 7, 8, 0)]
        ...
        [TestCase(CreatureConstants.Balor, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Twenty, null, false, 20, 19, 2)]
        [TestCase(CreatureConstants.BarbedDevil_Hamatula, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Eleven, null, false, 12, 13, 2)]
        [TestCase(CreatureConstants.Barghest, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Four, null, false, 0, 6, 0)]
        [TestCase(CreatureConstants.Barghest_Greater, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Five, null, false, 0, 9, 0)]
        ...
        [TestCase(CreatureConstants.BoneDevil_Osyluth, SizeConstants.Large, 10, 10, ChallengeRatingConstants.Nine, null, false, 12, 11, 2)]
        ...
        [TestCase(CreatureConstants.Chimera, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Seven, 2, false, 0, 9, 0)]
        ...
        [TestCase(CreatureConstants.Dragon_Bronze_Young, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Seven, 6, false, 1, 11, 0)]
        [TestCase(CreatureConstants.Dragon_Bronze_Juvenile, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Nine, null, false, 3, 14, 0)]
        [TestCase(CreatureConstants.Dragon_Bronze_YoungAdult, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Twelve, null, false, 5, 17, 0)]
        [TestCase(CreatureConstants.Dragon_Bronze_Adult, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Fifteen, null, false, 7, 20, 0)]
        [TestCase(CreatureConstants.Dragon_Bronze_MatureAdult, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Seventeen, null, false, 9, 23, 0)]
        [TestCase(CreatureConstants.Dragon_Bronze_Old, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Nineteen, null, false, 11, 26, 0)]
        [TestCase(CreatureConstants.Dragon_Bronze_VeryOld, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Twenty, null, false, 13, 29, 0)]
        [TestCase(CreatureConstants.Dragon_Bronze_Ancient, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.TwentyTwo, null, false, 15, 32, 0)]
        [TestCase(CreatureConstants.Dragon_Bronze_Wyrm, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.TwentyThree, null, false, 17, 35, 0)]
        [TestCase(CreatureConstants.Dragon_Bronze_GreatWyrm, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.TwentyFive, null, false, 19, 38, 0)]
        ...
        [TestCase(CreatureConstants.Dragon_Gold_Wyrmling, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Five, 4, false, 0, 7, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_VeryYoung, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Seven, 5, false, 0, 10, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_Young, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Nine, 6, false, 1, 13, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_Juvenile, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Eleven, null, false, 3, 16, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_YoungAdult, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Fourteen, null, false, 5, 19, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_Adult, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Sixteen, null, false, 7, 22, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_MatureAdult, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Nineteen, null, false, 9, 25, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_Old, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.TwentyOne, null, false, 11, 28, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_VeryOld, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.TwentyTwo, null, false, 13, 31, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_Ancient, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.TwentyFour, null, false, 15, 34, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_Wyrm, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.TwentyFive, null, false, 17, 37, 0)]
        [TestCase(CreatureConstants.Dragon_Gold_GreatWyrm, SizeConstants.Colossal, 30, 20, ChallengeRatingConstants.TwentySeven, null, false, 19, 40, 0)]
        ...
        [TestCase(CreatureConstants.Dragon_Silver_Wyrmling, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Four, 4, false, 0, 6, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_VeryYoung, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Five, 4, false, 0, 9, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_Young, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Seven, 5, false, 1, 12, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_Juvenile, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Ten, null, false, 3, 15, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_YoungAdult, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Thirteen, null, false, 5, 18, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_Adult, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Fifteen, null, false, 7, 21, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_MatureAdult, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Eighteen, null, false, 9, 24, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_Old, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.Twenty, null, false, 11, 27, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_VeryOld, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.TwentyOne, null, false, 13, 30, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_Ancient, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.TwentyThree, null, false, 15, 33, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_Wyrm, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.TwentyFour, null, false, 17, 36, 0)]
        [TestCase(CreatureConstants.Dragon_Silver_GreatWyrm, SizeConstants.Colossal, 30, 20, ChallengeRatingConstants.TwentySix, null, false, 19, 39, 0)]
        ...
        [TestCase(CreatureConstants.Glabrezu, SizeConstants.Huge, 15, 15, ChallengeRatingConstants.Thirteen, null, false, 14, 19, 2)]
        ...
        [TestCase(CreatureConstants.Nalfeshnee, SizeConstants.Huge, 15, 15, ChallengeRatingConstants.Fourteen, null, false, 12, 18, 2)]
        [TestCase(CreatureConstants.NightHag, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Nine, null, false, 8, 11, 2)]
        ...
        [TestCase(CreatureConstants.Phasm, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Seven, null, false, 0, 5, 0)]
        ...
        [TestCase(CreatureConstants.Spider_Monstrous_Colossal, SizeConstants.Colossal, 40, 30, ChallengeRatingConstants.Eleven, null, false, 0, 18, 0)]
        [TestCase(CreatureConstants.Spider_Monstrous_Gargantuan, SizeConstants.Gargantuan, 20, 15, ChallengeRatingConstants.Eight, null, false, 0, 10, 0)]
        [TestCase(CreatureConstants.Spider_Monstrous_Huge, SizeConstants.Huge, 15, 10, ChallengeRatingConstants.Five, null, false, 0, 5, 0)]
        [TestCase(CreatureConstants.Spider_Monstrous_Large, SizeConstants.Large, 10, 5, ChallengeRatingConstants.Two, null, false, 0, 2, 0)]
        [TestCase(CreatureConstants.Spider_Monstrous_Medium, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.One, null, false, 0, 1, 0)]
        [TestCase(CreatureConstants.Spider_Monstrous_Small, SizeConstants.Small, 5, 5, ChallengeRatingConstants.OneHalf, null, false, 0, 0, 0)]
        [TestCase(CreatureConstants.Spider_Monstrous_Tiny, SizeConstants.Tiny, 2.5, 0, ChallengeRatingConstants.OneFourth, null, false, 0, 0, 0)]
        ...
        [TestCase(CreatureConstants.YuanTi_Halfblood, SizeConstants.Medium, 5, 5, ChallengeRatingConstants.Five, 5, true, 4, 4, 2)]
