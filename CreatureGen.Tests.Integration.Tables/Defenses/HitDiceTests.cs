...
namespace CreatureGen.Tests.Integration.Tables.Defenses
{
    ...
    public class HitDiceTests : AdjustmentsTests
    {
        ...
        [TestCase(CreatureConstants.Spider_Monstrous_Colossal, 32)]
        [TestCase(CreatureConstants.Spider_Monstrous_Gargantuan, 16)]
        [TestCase(CreatureConstants.Spider_Monstrous_Huge, 8)]
        [TestCase(CreatureConstants.Spider_Monstrous_Large, 4)]
        [TestCase(CreatureConstants.Spider_Monstrous_Medium, 2)]
        [TestCase(CreatureConstants.Spider_Monstrous_Small, 1)]
        [TestCase(CreatureConstants.Spider_Monstrous_Tiny, .5)]
