    ...
    public class SpecialQualityTestData
    {
        ...
        public static IEnumerable Creatures
        {
            get
            {
                ...
                testCases[CreatureConstants.Kraken].Add(SpecialQualityHelper.BuildData(FeatConstants.SpecialQualities.InkCloud, frequencyQuantity: 1, frequencyTimePeriod: FeatConstants.Frequencies.Turn));
