...
namespace CreatureGen.Tests.Integration.Tables.Feats.Data
{
    ...
    public class FeatDataTests : DataTests
    {
        ...
        [TestCase(FeatConstants.RapidReload, 0, "", 0, "", 0, 0, 0, 0, false, false, false)]
        ...
        [TestCase(FeatConstants.WeaponProficiency_Exotic, 0, FeatConstants.WeaponProficiency_Exotic, 0, "", 0, 0, 1, 0, false, false, false)]
        [TestCase(FeatConstants.WeaponProficiency_Martial, 0, FeatConstants.WeaponProficiency_Martial, 0, "", 0, 0, 1, 0, false, false, false)]
        [TestCase(FeatConstants.WeaponProficiency_Simple, 0, FeatConstants.WeaponProficiency_Simple, 0, "", 0, 0, 1, 0, false, false, false)]
        //INFO: Being a Fighter is a requirement for these feats
        ...
        [TestCase(FeatConstants.Monster.AbilityFocus, 0, "", 0, "", 0, 0, 0, 0, false, true, false)]
        [TestCase(FeatConstants.Monster.AwesomeBlow, 0, "", 0, "", 0, 0, 0, 0, false, false, false)] //size requirement
        [TestCase(FeatConstants.Monster.CraftConstruct, 0, "", 0, "", 0, 0, 0, 0, false, false, false)]
        [TestCase(FeatConstants.Monster.EmpowerSpellLikeAbility, 0, "", 0, "", 0, 6, 0, 0, false, false, true)]
        ...
        [TestCase(FeatConstants.Monster.MultiweaponFighting_Greater, 0, "", 0, "", 0, 0, 3, 0, false, false, false)]
        [TestCase(FeatConstants.Monster.MultiweaponFighting_Improved, 0, "", 0, "", 0, 0, 3, 0, false, false, false)]
        [TestCase(FeatConstants.Monster.NaturalArmor_Improved, 0, "", 0, "", 0, 0, 0, 0, true, false, false)]
        [TestCase(FeatConstants.Monster.NaturalAttack_Improved, 4, "", 0, "", 0, 0, 0, 1, false, false, false)]
        [TestCase(FeatConstants.Monster.QuickenSpellLikeAbility, 0, "", 0, "", 0, 10, 0, 0, false, false, true)]
        [TestCase(FeatConstants.Monster.Snatch, 0, "", 0, "", 0, 0, 0, 0, false, false, false)] //size requirement
        [TestCase(FeatConstants.Monster.Wingover, 0, "", 0, "", 0, 0, 0, 0, false, false, false)]
