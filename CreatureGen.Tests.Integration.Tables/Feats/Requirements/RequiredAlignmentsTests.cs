        ...
        public class RequiredAlignmentsTestData
        {
            ...
            public static IEnumerable CreatureSpecialQualities
            {
                get
                {
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Aboleth, FeatConstants.SpecialQualities.Psionic, SpellConstants.HypnoticPattern)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Aboleth, FeatConstants.SpecialQualities.Psionic, SpellConstants.IllusoryWall)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Aboleth, FeatConstants.SpecialQualities.Psionic, SpellConstants.MirageArcana)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Aboleth, FeatConstants.SpecialQualities.Psionic, SpellConstants.PersistentImage)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Aboleth, FeatConstants.SpecialQualities.Psionic, SpellConstants.ProgrammedImage)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Aboleth, FeatConstants.SpecialQualities.Psionic, SpellConstants.ProjectImage)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Couatl, FeatConstants.SpecialQualities.Psionic, SpellConstants.DetectAlignment)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Couatl, FeatConstants.SpecialQualities.Psionic, SpellConstants.DetectThoughts)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Couatl, FeatConstants.SpecialQualities.Psionic, SpellConstants.Invisibility)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Couatl, FeatConstants.SpecialQualities.Psionic, SpellConstants.PlaneShift)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Couatl, FeatConstants.EschewMaterials, string.Empty)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Darkmantle, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Darkness)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Derro, FeatConstants.WeaponProficiency_Exotic, WeaponConstants.LightRepeatingCrossbow)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Derro_Sane, FeatConstants.WeaponProficiency_Exotic, WeaponConstants.LightRepeatingCrossbow)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Elder, FeatConstants.WeaponFinesse, string.Empty)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Elder, FeatConstants.Initiative_Improved, string.Empty)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Greater, FeatConstants.WeaponFinesse, string.Empty)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Greater, FeatConstants.Initiative_Improved, string.Empty)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Huge, FeatConstants.WeaponFinesse, string.Empty)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Huge, FeatConstants.Initiative_Improved, string.Empty)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Large, FeatConstants.WeaponFinesse, string.Empty)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Large, FeatConstants.Initiative_Improved, string.Empty)] = new string[0];

                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Medium, FeatConstants.WeaponFinesse, string.Empty)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Medium, FeatConstants.Initiative_Improved, string.Empty)] = new string[0];

                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Small, FeatConstants.WeaponFinesse, string.Empty)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Elemental_Air_Small, FeatConstants.Initiative_Improved, string.Empty)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Githyanki, FeatConstants.SpecialQualities.Psionic, SpellConstants.Daze)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Githyanki, FeatConstants.SpecialQualities.Psionic, SpellConstants.MageHand)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Githzerai, FeatConstants.SpecialQualities.Psionic, SpellConstants.Daze)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Githzerai, FeatConstants.SpecialQualities.Psionic, SpellConstants.FeatherFall)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Githzerai, FeatConstants.SpecialQualities.Psionic, SpellConstants.Shatter)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Grig, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Invisibility + ": self only")] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Grig_WithFiddle, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Invisibility + ": self only")] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.HoundArchon, FeatConstants.SpecialQualities.AuraOfMenace, string.Empty)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.KuoToa, FeatConstants.WeaponProficiency_Exotic, WeaponConstants.PincerStaff)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.LanternArchon, FeatConstants.SpecialQualities.AuraOfMenace, string.Empty)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Lizardfolk, FeatConstants.WeaponProficiency_Simple, WeaponConstants.Club)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Lizardfolk, FeatConstants.WeaponProficiency_Simple, WeaponConstants.Javelin)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.MindFlayer, FeatConstants.SpecialQualities.Psionic, SpellConstants.CharmMonster)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.MindFlayer, FeatConstants.SpecialQualities.Psionic, SpellConstants.DetectThoughts)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.MindFlayer, FeatConstants.SpecialQualities.Psionic, SpellConstants.Levitate)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.MindFlayer, FeatConstants.SpecialQualities.Psionic, SpellConstants.PlaneShift)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.MindFlayer, FeatConstants.SpecialQualities.Psionic, SpellConstants.Suggestion)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Naga_Dark, FeatConstants.EschewMaterials, string.Empty)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Salamander_Average, FeatConstants.WeaponProficiency_Simple, WeaponConstants.Spear)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Salamander_Flamebrother, FeatConstants.WeaponProficiency_Simple, WeaponConstants.Spear)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Salamander_Noble, FeatConstants.WeaponProficiency_Simple, WeaponConstants.Longspear)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Blue, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.ChaosHammer)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Blue, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.HoldPerson)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Blue, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Passwall)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Blue, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Telekinesis)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.AnimateObjects)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.ChaosHammer)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DeeperDarkness)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DetectMagic)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DispelAlignment)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Fear)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.FingerOfDeath)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Fireball)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Fly)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Identify)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Invisibility)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.MagicCircleAgainstAlignment)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.SeeInvisibility)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Shatter)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.CircleOfDeath)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.CloakOfChaos)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.WordOfChaos)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Implosion)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Death, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.PowerWordBlind)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.ChaosHammer)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DeeperDarkness)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DetectMagic)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Identify)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Invisibility)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.LightningBolt)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.MagicCircleAgainstAlignment)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.SeeInvisibility)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Shatter)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.AnimateObjects)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DispelAlignment)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Fly)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Gray, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.PowerWordStun)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Green, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.ChaosHammer)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Green, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DetectMagic)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Green, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DetectThoughts)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Green, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Fear)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Green, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.ProtectionFromAlignment)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Green, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.SeeInvisibility)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Green, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Shatter)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Green, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DispelAlignment)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Green, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DeeperDarkness)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Slaad_Green, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Fireball)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Snake_Viper_Small, FeatConstants.WeaponFinesse, string.Empty)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Snake_Viper_Tiny, FeatConstants.WeaponFinesse, string.Empty)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Titan, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.BestowCurse)] = new[] { AlignmentConstants.ChaoticEvil };
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Titan, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.CrushingHand)] = new[] { AlignmentConstants.ChaoticEvil };
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Titan, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Daylight)] = new[] { AlignmentConstants.ChaoticGood, AlignmentConstants.ChaoticNeutral };
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Titan, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.DeeperDarkness)] = new[] { AlignmentConstants.ChaoticEvil };
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Titan, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.HolySmite)] = new[] { AlignmentConstants.ChaoticGood, AlignmentConstants.ChaoticNeutral };
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Titan, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.RemoveCurse)] = new[] { AlignmentConstants.ChaoticGood, AlignmentConstants.ChaoticNeutral };
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Titan, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.Restoration_Greater)] = new[] { AlignmentConstants.ChaoticGood, AlignmentConstants.ChaoticNeutral };
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Titan, FeatConstants.SpecialQualities.SpellLikeAbility, SpellConstants.UnholyBlight)] = new[] { AlignmentConstants.ChaoticEvil };
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.TrumpetArchon, FeatConstants.SpecialQualities.AuraOfMenace, string.Empty)] = new string[0];
            ...
            public static IEnumerable CreatureSubtypeSpecialQualities
            {
                get
                {
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Types.Subtypes.Halfling, FeatConstants.ArmorProficiency_Light, string.Empty)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Types.Subtypes.Halfling, FeatConstants.WeaponProficiency_Martial, WeaponConstants.Longsword)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Types.Subtypes.Halfling, FeatConstants.WeaponProficiency_Simple, WeaponConstants.LightCrossbow)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Types.Subtypes.Swarm, FeatConstants.SpecialQualities.HalfDamage, AttributeConstants.DamageTypes.Piercing)] = new string[0];
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Types.Subtypes.Swarm, FeatConstants.SpecialQualities.HalfDamage, AttributeConstants.DamageTypes.Slashing)] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Types.Subtypes.Swarm, FeatConstants.SpecialQualities.Immunity, "Weapon damage")] = new string[0];
                    ...
                    testCases[SpecialQualityHelper.BuildRequirementKey(CreatureConstants.Types.Subtypes.Swarm, FeatConstants.SpecialQualities.Vulnerability, "High winds")] = new string[0];
