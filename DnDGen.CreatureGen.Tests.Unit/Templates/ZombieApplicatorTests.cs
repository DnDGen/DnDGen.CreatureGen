...
namespace DnDGen.CreatureGen.Tests.Unit.Templates
{
    ...
    public class ZombieApplicatorTests
    {
        ...
        [TestCase(false, "subtype 1", ChallengeRatingConstants.CR1_2nd, AlignmentConstants.TrueNeutral)]
        [TestCase(false, "subtype 1", ChallengeRatingConstants.CR1, AlignmentConstants.NeutralEvil)]
        [TestCase(false, "wrong subtype", ChallengeRatingConstants.CR1_2nd, AlignmentConstants.NeutralEvil)]
        [TestCase(true, "subtype 1", ChallengeRatingConstants.CR1_2nd, AlignmentConstants.NeutralEvil)]
        ...
        public void ApplyTo_ReturnsCreature_WithFilters()
        {
            ...
            var creature = applicator.ApplyTo(baseCreature, false, "subtype 1", ChallengeRatingConstants.CR1_2nd, AlignmentConstants.NeutralEvil);
        ...
        public async Task ApplyToAsync_ReturnsCreature_WithFilters()
        {
            ...
            var creature = await applicator.ApplyToAsync(baseCreature, false, "subtype 1", ChallengeRatingConstants.CR1_2nd, AlignmentConstants.NeutralEvil);
            Assert.That(creature.Template, Is.EqualTo(CreatureConstants.Templates.Zombie));
        }
        ...
        public void GetCompatibleCreatures_ReturnEmpty_WhenAlignmentFilterInvalid(string alignmentFilter)
        {
            ...
            var compatibleCreatures = applicator.GetCompatibleCreatures(creatures, false, alignment: alignmentFilter);
            Assert.That(compatibleCreatures, Is.Empty);
        }
        ...
        public void GetCompatibleCreatures_ReturnCompatibleCreatures_WhenAlignmentFilterValid()
        {
            ...
            var compatibleCreatures = applicator.GetCompatibleCreatures(creatures, false, alignment: AlignmentConstants.NeutralEvil);
        ...
        public void GetCompatibleCreatures_WithChallengeRating_ReturnsCompatibleCreatures(string challengeRatingFilter, double lower, double upper)
        {
            ...
            var compatibleCreatures = applicator.GetCompatibleCreatures(creatures, false, challengeRating: challengeRatingFilter);
        ...
        public void GetCompatibleCreatures_WithType_ReturnsCompatibleCreatures()
        {
            ...
            var compatibleCreatures = applicator.GetCompatibleCreatures(creatures, false, type: CreatureConstants.Types.Undead);
            Assert.That(compatibleCreatures, Is.EqualTo(new[] { "my creature", "my other creature" }));
        }
