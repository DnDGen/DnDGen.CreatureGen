...
{
    [TestFixture]
    public class HalfDragonBrassApplicatorTests
    {
        ...
        private const string template = CreatureConstants.Templates.HalfDragon_Brass;
        ...
        public void Setup()
        {
            ...
            applicator = new HalfDragonBrassApplicator(
