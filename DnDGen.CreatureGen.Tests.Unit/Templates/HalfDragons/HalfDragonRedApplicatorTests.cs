...
{
    [TestFixture]
    public class HalfDragonRedApplicatorTests
    {
        ...
        private const string template = CreatureConstants.Templates.HalfDragon_Red;
        ...
        public void Setup()
        {
            ...
            applicator = new HalfDragonRedApplicator(
