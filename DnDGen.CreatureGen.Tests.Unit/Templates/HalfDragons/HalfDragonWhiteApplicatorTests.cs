...
{
    [TestFixture]
    public class HalfDragonWhiteApplicatorTests
    {
        ...
        private const string template = CreatureConstants.Templates.HalfDragon_White;
        ...
        public void Setup()
        {
            ...
            applicator = new HalfDragonWhiteApplicator(
