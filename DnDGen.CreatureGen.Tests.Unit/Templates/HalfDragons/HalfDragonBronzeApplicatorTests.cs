...
{
    [TestFixture]
    public class HalfDragonBronzeApplicatorTests
    {
        ...
        private const string template = CreatureConstants.Templates.HalfDragon_Bronze;
        ...
        public void Setup()
        {
            ...
            applicator = new HalfDragonBronzeApplicator(
