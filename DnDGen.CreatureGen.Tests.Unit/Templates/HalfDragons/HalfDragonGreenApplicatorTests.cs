...
{
    [TestFixture]
    public class HalfDragonGreenApplicatorTests
    {
        ...
        private const string template = CreatureConstants.Templates.HalfDragon_Green;
        ...
        public void Setup()
        {
            ...
            applicator = new HalfDragonGreenApplicator(
