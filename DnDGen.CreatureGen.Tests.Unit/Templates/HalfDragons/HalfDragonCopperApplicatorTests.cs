...
{
    [TestFixture]
    public class HalfDragonCopperApplicatorTests
    {
        ...
        private const string template = CreatureConstants.Templates.HalfDragon_Copper;
        ...
        public void Setup()
        {
            ...
            applicator = new HalfDragonCopperApplicator(
