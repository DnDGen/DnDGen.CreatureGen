...
namespace DnDGen.CreatureGen.Tests.Unit.Templates
{
    ...
    public class LichApplicatorTests
    {
        ...
        public void GetCompatibleCreatures_WithType_ReturnCompatibleCreatures(string type)
        {
            ...
            var types = new Dictionary<string, IEnumerable<string>>
            {
                ["creature 1"] = [CreatureConstants.Types.Humanoid, "subtype 1", "subtype 2"],
                ["creature 2"] = [CreatureConstants.Types.Humanoid, "subtype 3"],
                ["creature 3"] = [CreatureConstants.Types.Humanoid]
            };
        ...
        public void GetCompatibleCreatures_WithType_ReturnCompatibleCreatures_FilterOutInvalidTypes()
        {
            ...
            {
                ["creature 1"] = [CreatureConstants.Types.Humanoid, "subtype 1", "subtype 2"],
                ["creature 2"] = [CreatureConstants.Types.Humanoid, "subtype 2"],
                ["creature 3"] = [CreatureConstants.Types.Humanoid, "subtype 2", "subtype 3"],
                ["wrong creature 5"] = [CreatureConstants.Types.Humanoid, "subtype 3", "subtype 1"]
            };
        ...
        public void GetCompatiblePrototypes_FromNames_ReturnCompatibleCreatures(bool asCharacter)
        {
            ...
            var prototypes = new[]
            {
                new CreaturePrototypeBuilder()
                    .WithTestValues()
                    .WithName("creature 1")
                    .WithCreatureType([.. types["creature 1"]])
        ...
        public void GetCompatiblePrototypes_FromNames_WithChallengeRating_ReturnCompatibleCreatures(string original, string filter)
        {
            ...
            var types = new Dictionary<string, IEnumerable<string>>
            {
                ...
                ["creature 2"] = [CreatureConstants.Types.Humanoid, "subtype 3"],
                ["creature 3"] = [CreatureConstants.Types.Humanoid],
                ["wrong creature 5"] = [CreatureConstants.Types.Humanoid, "subtype 1", "subtype 2"]
            };
