...
namespace DnDGen.CreatureGen.Tests.Unit.Templates
{
    ...
    public class SkeletonApplicatorTests
    {
        ...
        public void ApplyTo_DemographicsAdjusted()
        {
            ...
            mockCollectionSelector
                .Setup(s => s.SelectRandomFrom(Config.Name, TableNameConstants.Collection.Appearances, CreatureConstants.Templates.Skeleton))
                .Returns("I am spooky and scary.");
            ...
            Assert.That(creature.Demographics.Appearance, Is.EqualTo("I am spooky and scary."));
        }
