...
namespace DnDGen.CreatureGen.Tests.Unit.Templates
{
    ...
    public class LycanthropeApplicatorIsCompatibleTests
    {
        ...
        public void GetCompatibleCreatures_BySize(string creatureSize, string animalSize, bool compatible)
        {
            ...
            var data = SetUpCreatureData();
            data["my creature"].Size = creatureSize;
        ...
        public void GetCompatibleCreatures_ChallengeRatingMustMatch(string original, double animalHitDiceQuantity, string challengeRating, bool compatible)
        {
            ...
            var data = SetUpCreatureData();
            data["my creature"].ChallengeRating = original;
            data["my animal"].HitDiceQuantity = animalHitDiceQuantity;
            ...
            bool compatible)
        {
            ...
            data["my animal"].HitDiceQuantity = animalHitDiceQuantity;
            data["my creature"].ChallengeRating = original;
            data["my creature"].HitDiceQuantity = creatureHitDiceQuantity;
            ...
            bool compatible)
        {
            ...
            var alignments = new Dictionary<string, IEnumerable<string>>
            {
                ["my creature"] = ["other alignment", creatureAlignment, "original alignment"]
            };
