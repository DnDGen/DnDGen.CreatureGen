...
namespace DnDGen.CreatureGen.Tests.Unit.Creatures
{
    ...
    public class CreatureConstantsTests
    {
        ...
        [TestCase(CreatureConstants.AnimatedObject_Colossal_MultipleLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (More Than Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_MultipleLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (More Than Two Legs, Wooden)")]
        ...
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_MultipleLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (More Than Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_MultipleLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (More Than Two Legs, Wooden)")]
        ...
        [TestCase(CreatureConstants.AnimatedObject_Huge_MultipleLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (More Than Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge_MultipleLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (More Than Two Legs, Wooden)")]
        ...
        [TestCase(CreatureConstants.AnimatedObject_Large_MultipleLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (More Than Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Large_MultipleLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (More Than Two Legs, Wooden)")]
