...
namespace DnDGen.CreatureGen.Tests.Unit.Creatures
{
    ...
    public class CreatureConstantsTests
    {
        ...
        [TestCase(CreatureConstants.AnimatedObject_Colossal_Flexible, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (Flexible)")]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_MultipleLegs_Long, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (More Than Two Legs, Long)")]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_MultipleLegs_Long_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (More Than Two Legs, Long, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_MultipleLegs_Tall, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (More Than Two Legs, Tall)")]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_MultipleLegs_Tall_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (More Than Two Legs, Tall, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_Sheetlike, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (Sheetlike)")]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_TwoLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_TwoLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (Two Legs, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_Wheels_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (Wheels, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Colossal_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Colossal + " (Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan)]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_Flexible, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (Flexible)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_MultipleLegs_Long, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (More Than Two Legs, Long)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_MultipleLegs_Long_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (More Than Two Legs, Long, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_MultipleLegs_Tall, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (More Than Two Legs, Tall)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_MultipleLegs_Tall_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (More Than Two Legs, Tall, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_Sheetlike, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (Sheetlike)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_TwoLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_TwoLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (Two Legs, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_Wheels_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (Wheels, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Gargantuan_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Gargantuan + " (Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge)]
        [TestCase(CreatureConstants.AnimatedObject_Huge_Flexible, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (Flexible)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge_MultipleLegs_Long, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (More Than Two Legs, Long)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge_MultipleLegs_Long_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (More Than Two Legs, Long, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge_MultipleLegs_Tall, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (More Than Two Legs, Tall)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge_MultipleLegs_Tall_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (More Than Two Legs, Tall, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge_Sheetlike, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (Sheetlike)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge_TwoLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge_TwoLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (Two Legs, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge_Wheels_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (Wheels, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Huge_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Huge + " (Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Large, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large)]
        [TestCase(CreatureConstants.AnimatedObject_Large_Flexible, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (Flexible)")]
        [TestCase(CreatureConstants.AnimatedObject_Large_MultipleLegs_Long, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (More Than Two Legs, Long)")]
        [TestCase(CreatureConstants.AnimatedObject_Large_MultipleLegs_Long_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (More Than Two Legs, Long, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Large_MultipleLegs_Tall, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (More Than Two Legs, Tall)")]
        [TestCase(CreatureConstants.AnimatedObject_Large_MultipleLegs_Tall_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (More Than Two Legs, Tall, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Large_Sheetlike, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (Sheetlike)")]
        [TestCase(CreatureConstants.AnimatedObject_Large_TwoLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Large_TwoLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (Two Legs, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Large_Wheels_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (Wheels, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Large_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Large + " (Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Medium, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Medium)]
        [TestCase(CreatureConstants.AnimatedObject_Medium_Flexible, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Medium + " (Flexible)")]
        [TestCase(CreatureConstants.AnimatedObject_Medium_MultipleLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Medium + " (More Than Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Medium_MultipleLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Medium + " (More Than Two Legs, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Medium_Sheetlike, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Medium + " (Sheetlike)")]
        [TestCase(CreatureConstants.AnimatedObject_Medium_TwoLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Medium + " (Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Medium_TwoLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Medium + " (Two Legs, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Medium_Wheels_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Medium + " (Wheels, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Medium_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Medium + " (Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Small, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Small)]
        [TestCase(CreatureConstants.AnimatedObject_Small_Flexible, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Small + " (Flexible)")]
        [TestCase(CreatureConstants.AnimatedObject_Small_MultipleLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Small + " (More Than Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Small_MultipleLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Small + " (More Than Two Legs, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Small_Sheetlike, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Small + " (Sheetlike)")]
        [TestCase(CreatureConstants.AnimatedObject_Small_TwoLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Small + " (Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Small_TwoLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Small + " (Two Legs, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Small_Wheels_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Small + " (Wheels, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Small_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Small + " (Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Tiny, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Tiny)]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_Flexible, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Tiny + " (Flexible)")]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_MultipleLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Tiny + " (More Than Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_MultipleLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Tiny + " (More Than Two Legs, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_Sheetlike, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Tiny + " (Sheetlike)")]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_TwoLegs, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Tiny + " (Two Legs)")]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_TwoLegs_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Tiny + " (Two Legs, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_Wheels_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Tiny + " (Wheels, Wooden)")]
        [TestCase(CreatureConstants.AnimatedObject_Tiny_Wooden, CreatureConstants.Groups.AnimatedObject + ", " + SizeConstants.Tiny + " (Wooden)")]
