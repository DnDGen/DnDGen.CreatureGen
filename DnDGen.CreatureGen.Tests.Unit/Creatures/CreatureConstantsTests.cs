...
namespace DnDGen.CreatureGen.Tests.Unit.Creatures
{
    ...
    public class CreatureConstantsTests
    {
        ...
        [TestCase(CreatureConstants.Templates.Lycanthrope_Rat_Dire_Afflicted, "Lycanthrope, Rat (Wererat, Afflicted)")]
        [TestCase(CreatureConstants.Templates.Lycanthrope_Rat_Dire_Natural, "Lycanthrope, Rat (Wererat, Natural)")]
