...
namespace DnDGen.CreatureGen.Tests.Unit.Tables
{
    ...
    public class TableNameConstantsTests
    {
        ...
        [TestCase(TableNameConstants.Collection.ArmorClassBonuses, "ArmorClassBonuses")]
        ...
        [TestCase(TableNameConstants.Collection.SkillBonuses, "SkillBonuses")]
        ...
        [TestCase(TableNameConstants.TypeAndAmount.ArcaneSpellFailures, "ArcaneSpellFailures")]
        ...
        [TestCase(TableNameConstants.TypeAndAmount.GrappleBonuses, "GrappleBonuses")]
        ...
        [TestCase(TableNameConstants.TypeAndAmount.SizeModifiers, "SizeModifiers")]
        [TestCase(TableNameConstants.TypeAndAmount.SkillPoints, "SkillPoints")]
