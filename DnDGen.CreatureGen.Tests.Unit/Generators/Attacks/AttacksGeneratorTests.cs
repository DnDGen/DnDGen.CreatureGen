...
namespace DnDGen.CreatureGen.Tests.Unit.Generators.Attacks
{
    ...
    public class AttacksGeneratorTests
    {
        ...
        [TestCase(20, 20)]
        [TestCase(9266, 9266)]
        public void GenerateBaseAttackBonus_Good(int hitDiceQuantity, int bonus)
        {
            hitPoints.HitDice.Add(new HitDice { Quantity = hitDiceQuantity });

            var baseAttackBonus = attacksGenerator.GenerateBaseAttackBonus(BaseAttackQuality.Good, hitPoints);
        ...
        [TestCase(20, 15)]
        [TestCase(9266, 6949)]
        public void GenerateBaseAttackBonus_Average(int hitDiceQuantity, int bonus)
        {
            hitPoints.HitDice.Add(new HitDice { Quantity = hitDiceQuantity });

            var baseAttackBonus = attacksGenerator.GenerateBaseAttackBonus(BaseAttackQuality.Average, hitPoints);
            Assert.That(baseAttackBonus, Is.EqualTo(bonus));
        }
        ...
        [TestCase(20, 10)]
        [TestCase(9266, 4633)]
        public void GenerateBaseAttackBonus_Poor(int hitDiceQuantity, int bonus)
        {
            hitPoints.HitDice.Add(new HitDice { Quantity = hitDiceQuantity });

            var baseAttackBonus = attacksGenerator.GenerateBaseAttackBonus(BaseAttackQuality.Poor, hitPoints);
            Assert.That(baseAttackBonus, Is.EqualTo(bonus));
        }
