...
namespace DnDGen.CreatureGen.Tests.Unit.Generators.Creatures
{
    ...
    public class CreatureGeneratorRandomOfTypeWithChallengeRatingTests
    {
        ...
        public void GenerateRandomNameOfType_GenerateCreatureName_WithTemplate()
        {
            ...
            mockTemplateApplicator.Setup(a => a.IsCompatible(creatureName, false, "my type", "my challenge rating")).Returns(true);
            ...
            mockWrongTemplateApplicator1.Setup(a => a.IsCompatible(creatureName, false, "my type", "my challenge rating")).Returns(false);
            ...
            mockWrongTemplateApplicator2.Setup(a => a.IsCompatible(creatureName, false, "my type", "my challenge rating")).Returns(false);
            ...
            mockWrongTemplateApplicator3.Setup(a => a.IsCompatible(creatureName, false, "my type", "my challenge rating")).Returns(false);
        ...
        public void GenerateRandomNameOfType_GenerateRandomCreatureName_WithTemplate()
        {
            ...
            {
                var mockTemplateApplicator = new Mock<TemplateApplicator>();
                mockTemplateApplicator.Setup(a => a.IsCompatible(It.IsAny<string>(), false, "my type", "my challenge rating")).Returns(true);
        ...
        public void GenerateRandomNameOfType_ThrowException_WhenNotCompatible()
        {
            ...
            Assert.That(() => creatureGenerator.GenerateRandomNameOfType("my type", "my challenge rating"),
        ...
        public void GenerateRandomOfType_GenerateRandomCreatureName_NoTemplate()
        {
            ...
            {
                var mockTemplateApplicator = new Mock<TemplateApplicator>();
                mockTemplateApplicator.Setup(a => a.IsCompatible(It.IsAny<string>(), false, "my type", "my challenge rating")).Returns(false);
        ...
        public void GenerateRandomOfType_ThrowException_WhenNotCompatible()
        {
            ...
            Assert.That(() => creatureGenerator.GenerateRandomOfType("my type", "my challenge rating"),
                Throws.InstanceOf<InvalidCreatureException>().With.Message.EqualTo("Invalid creature:\n\tAs Character: False\n\tType: my type\n\tCR: my challenge rating"));
        }
        ...
        public void GenerateRandomOfTypeAsync_ThrowException_WhenNotCompatible()
        {
            ...
            Assert.That(async () => await creatureGenerator.GenerateRandomOfTypeAsync("my type", "my challenge rating"),
                Throws.InstanceOf<InvalidCreatureException>().With.Message.EqualTo("Invalid creature:\n\tAs Character: False\n\tType: my type\n\tCR: my challenge rating"));
        }
