...
namespace DnDGen.CreatureGen.Tests.Unit.Generators.Creatures
{
    ...
    internal class CreatureGeneratorGenerateRandomTests : CreatureGeneratorTestsBase
    {
        ...
        public void GenerateRandom_GenerateCreatureName_NoTemplate(bool asCharacter, string type, string cr, string alignment)
        {
            ...
            mockNoneApplicator
                .Setup(a => a.GetCompatibleCreatures(It.IsAny<IEnumerable<string>>(), asCharacter, null, filters))
                .Returns((IEnumerable<string> cc, bool asC, AbilityRandomizer r, Filters f) => cc.Intersect([creatureName]));
        ...
        public void BUG_GenerateRandom_GenerateCreatureName_EmptyTemplate(string empty)
        {
            ...
            var mockNoneApplicator = new Mock<TemplateApplicator>();
            mockNoneApplicator
                .Setup(a => a.GetCompatibleCreatures(It.IsAny<IEnumerable<string>>(), false, null, filters))
                .Returns((IEnumerable<string> cc, bool asC, AbilityRandomizer r, Filters f) => cc.Intersect([creatureName]));
            ...
            var creature = creatureGenerator.GenerateRandom(false, null, filters);
            Assert.That(creature.Name, Is.EqualTo(creatureName));
            Assert.That(creature.Templates, Is.Empty);
        }
        ...
        public void GenerateRandom_GenerateCreatureName_WithPresetNoneTemplate(bool asCharacter, string type, string cr, string alignment)
        {
            ...
            SetUpCreature(creatureName, asCharacter, type, cr, alignment, null, CreatureConstants.Templates.None);
        ...
        public void GenerateRandom_GenerateCreatureName_WithMultiplePresetTemplates(bool asCharacter, string type, string cr, string alignment)
        {
            ...
            mockTemplateApplicator1
                .Setup(a => a.GetCompatiblePrototypes(It.IsAny<IEnumerable<string>>(), asCharacter, null, filters))
                .Returns((IEnumerable<string> cc, bool asC, AbilityRandomizer r, Filters f) => cc.Select(c => new CreaturePrototype { Name = c }));
        ...
        public void GenerateRandom_GenerateRandomCreatureName_NoTemplate(bool asCharacter, string type, string cr, string alignment)
        {
            ...
            mockNoneApplicator
                .Setup(a => a.GetCompatibleCreatures(It.IsAny<IEnumerable<string>>(), asCharacter, null, filters))
                .Returns((IEnumerable<string> cc, bool asC, AbilityRandomizer r, Filters f) => cc.Except(["wrong creature"]));
        ...
        public void GenerateRandom_GenerateRandomCreatureName_WithRandomTemplate(bool asCharacter, string type, string cr, string alignment)
        {
            ...
            mockTemplateApplicator
                .Setup(a => a.GetCompatibleCreatures(It.IsAny<IEnumerable<string>>(), asCharacter, null, filters))
                .Returns((IEnumerable<string> cc, bool asC, AbilityRandomizer r, Filters f) => cc.Except(["other wrong creature"]));
        ...
        {
            var filters = new Filters();
            filters.Templates.AddRange(["my template", "my other template"]);
