...
namespace DnDGen.CreatureGen.Tests.Unit.Generators.Creatures
{
    ...
    public class CreatureGeneratorRandomOfTemplateTests
    {
        ...
        public void GenerateRandomNameOfTemplate_GenerateCreatureName()
        {
            ...
            mockTemplateApplicator.Setup(a => a.IsCompatible(creatureName, null, null)).Returns(true);
        ...
        public void GenerateRandomNameOfTemplate_GenerateRandomCreatureName()
        {
            ...
            var mockTemplateApplicator = new Mock<TemplateApplicator>();
            mockTemplateApplicator.Setup(a => a.IsCompatible(It.IsAny<string>(), null, null)).Returns(true);
            mockCollectionSelector
