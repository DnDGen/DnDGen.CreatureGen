...
{
    [TestFixture]
    internal class CreatureGeneratorRandomOfTemplateTests : CreatureGeneratorTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        public void GenerateRandomNameOfTemplate_GenerateCreatureName()
        {
            ...
            var name = creatureGenerator.GenerateRandomName(false, "my template");
        ...
        public void GenerateRandomNameOfTemplate_ThrowsException_WhenNotValid()
        {
            ...
            Assert.That(() => creatureGenerator.GenerateRandomName(false, "my template"),
        ...
        public void GenerateRandomOfTemplate_GenerateCreatureName()
        {
            ...
            var creature = creatureGenerator.GenerateRandom(false, "my template");
        ...
        public void GenerateRandomOfTemplate_ThrowsException_WhenNotValid()
        {
            ...
            Assert.That(() => creatureGenerator.GenerateRandom(false, "my template"),
                Throws.InstanceOf<InvalidCreatureException>().With.Message.EqualTo($"Invalid creature:\n\tAs Character: False\n\tTemplate: my template"));
        }
        ...
        public async Task GenerateRandomOfTemplateAsync_IfCreatureHasNotHitDice_ChallengeRatingIsZero()
        {
            ...
            var creature = await creatureGenerator.GenerateRandomAsync(false, "my template");
            Assert.That(creature.HitPoints.HitDiceQuantity, Is.Zero);
            Assert.That(creature.ChallengeRating, Is.EqualTo(ChallengeRatingConstants.CR0));
        ...
        public async Task GenerateRandomOfTemplateAsync_ThrowsException_WhenNotValid()
        {
            ...
            Assert.That(async () => await creatureGenerator.GenerateRandomAsync(false, "my template"),
                Throws.InstanceOf<InvalidCreatureException>().With.Message.EqualTo($"Invalid creature:\n\tAs Character: False\n\tTemplate: my template"));
        }
