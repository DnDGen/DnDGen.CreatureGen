...
{
    [TestFixture]
    public class CreatureGeneratorRandomOfTemplateWithChallengeRatingAsCharacterTests
    {
        ...
        public void GenerateRandomNameOfTemplateAsCharacter_GenerateCreatureName()
        {
            ...
            var name = creatureGenerator.GenerateRandomNameOfTemplateAsCharacter("my template", "my challenge rating");
        ...
        public void GenerateRandomNameOfTemplateAsCharacter_GenerateRandomCreatureName()
        {
            ...
            mockTemplateApplicator.Setup(a => a.GetPotentialChallengeRating(It.IsAny<string>(), true)).Returns("my challenge rating");
        ...
        public void GenerateRandomOfTemplateAsCharacter_GenerateCreatureName()
        {
            ...
            var creature = creatureGenerator.GenerateRandomOfTemplateAsCharacter("my template", "my challenge rating");
        ...
        public void GenerateRandomOfTemplateAsCharacter_GenerateCreatureSpace()
        {
            ...
            var mockTemplateApplicator = new Mock<TemplateApplicator>();
            mockTemplateApplicator.Setup(a => a.IsCompatible(creatureName, true, null, "my challenge rating")).Returns(true);
            mockTemplateApplicator.Setup(a => a.GetPotentialChallengeRating(creatureName, true)).Returns("my challenge rating");
            mockTemplateApplicator.Setup(a => a.ApplyTo(It.Is<Creature>(c => c.Name == creatureName))).Returns((Creature c) => c);
        ...
        public async Task GenerateRandomOfTemplateAsCharacterAsync_IfCreatureHasNotHitDice_ChallengeRatingIsZero()
        {
            ...
            var creature = await creatureGenerator.GenerateRandomOfTemplateAsCharacterAsync("my template", "my challenge rating");
            Assert.That(creature.HitPoints.HitDiceQuantity, Is.Zero);
            Assert.That(creature.ChallengeRating, Is.EqualTo(ChallengeRatingConstants.CR0));
