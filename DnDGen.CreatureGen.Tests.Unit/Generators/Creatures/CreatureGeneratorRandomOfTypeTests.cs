...
namespace DnDGen.CreatureGen.Tests.Unit.Generators.Creatures
{
    ...
    public class CreatureGeneratorRandomOfTypeTests
    {
        ...
        public void Setup()
        {
            ...
            SetUpCreature("creature", "template", false, "type");
        ...
        private void SetUpCreature(string creatureName, string templateName, bool asCharacter, string type)
        {
            ...
            defaultTemplateApplicator.Setup(a => a.IsCompatible(creatureName, asCharacter, type, null)).Returns(true);
        ...
        public void GenerateRandomNameOfType_GenerateCreatureName_WithTemplate()
        {
            ...
            mockTemplateApplicator.Setup(a => a.IsCompatible(creatureName, false, "my type", null)).Returns(true);
            ...
            mockWrongTemplateApplicator1.Setup(a => a.IsCompatible(creatureName, false, "my type", null)).Returns(false);
            ...
            mockWrongTemplateApplicator2.Setup(a => a.IsCompatible(creatureName, false, "my type", null)).Returns(false);
        ...
        public void GenerateRandomNameOfType_GenerateRandomCreatureName_WithTemplate()
        {
            ...
            {
                var mockTemplateApplicator = new Mock<TemplateApplicator>();
                mockTemplateApplicator.Setup(a => a.IsCompatible(It.IsAny<string>(), false, "my type", null)).Returns(true);
        ...
        public void GenerateRandomOfType_GenerateCreatureName_NoTemplate()
        {
            ...
            SetUpCreature(creatureName, CreatureConstants.Templates.None, false, "my type");
        ...
        public void GenerateRandomOfType_GenerateCreatureName_WithTemplate()
        {
            ...
            SetUpCreature(creatureName, template, false, "my type");
        ...
        public void GenerateRandomOfType_GenerateRandomCreatureName_NoTemplate()
        {
            ...
            {
                var mockTemplateApplicator = new Mock<TemplateApplicator>();
                mockTemplateApplicator.Setup(a => a.IsCompatible(It.IsAny<string>(), false, "my type", null)).Returns(false);
        ...
        {
            var creatureName = CreatureConstants.Human;
            SetUpCreature(creatureName, CreatureConstants.Templates.None, false, startType);
