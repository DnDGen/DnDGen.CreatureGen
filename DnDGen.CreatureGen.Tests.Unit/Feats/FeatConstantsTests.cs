...
namespace DnDGen.CreatureGen.Tests.Unit.Feats
{
    ...
    public class FeatConstantsTests
    {
        ...
        [TestCase(FeatConstants.SpecialQualities.Carapace, "Carapace")]
        [TestCase(FeatConstants.SpecialQualities.ChameleonPower, "Chameleon Power")]
        ...
        [TestCase(FeatConstants.SpecialQualities.ElectricitySense, "Electricity Sense")]
        ...
        [TestCase(FeatConstants.SpecialQualities.Ferocity, "Ferocity")]
        [TestCase(FeatConstants.SpecialQualities.FindMaster, "Find Master")]
        ...
        [TestCase(FeatConstants.SpecialQualities.Guard, "Guard")]
        ...
        [TestCase(FeatConstants.SpecialQualities.LycanthropicEmpathy, "Lycanthropic Empathy")]
        ...
        [TestCase(FeatConstants.SpecialQualities.Rejuvenation, "Rejuvenation")]
        ...
        [TestCase(FeatConstants.SpecialQualities.ShadowBlend, "Shadow Blend")]
        ...
        [TestCase(FeatConstants.SpecialQualities.SingleActionsOnly, "Single Actions Only")]
        ...
        [TestCase(FeatConstants.SpecialQualities.SpellStoring, "Spell Storing")]
        ...
        [TestCase(FeatConstants.SpecialQualities.SunlightPowerlessness, "Sunlight Powerlessness")]
