...
{
    internal class LycanthropePolarBearAfflictedApplicator : LycanthropeApplicator
    {
        protected override string LycanthropeSpecies => CreatureConstants.Templates.Lycanthrope_Bear_Polar_Afflicted;
        protected override string AnimalSpecies => CreatureConstants.Bear_Polar;

        public LycanthropePolarBearAfflictedApplicator(
