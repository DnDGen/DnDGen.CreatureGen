        ...
        ICollectionTypeAndAmountSelector typeAndAmountSelector) : TemplateApplicator
    {
        ...
        public IEnumerable<string> GetCompatibleCreatures(IEnumerable<string> sourceCreatures, bool asCharacter, AbilityRandomizer abilityRandomizer = null, Filters filters = null)
        {
            var templateCreatures = collectionSelector.SelectFrom(
                ...
                CreatureConstants.Templates.HalfFiend + asCharacter);
            ...
            {
                var groupName = CreatureConstants.Templates.HalfFiend + filters.Type;
            ...
            {
                var groupName = CreatureConstants.Templates.HalfFiend + filters.Alignment;
            ...
            {
                var groupName = CreatureConstants.Templates.HalfFiend + asCharacter + filters.ChallengeRating;
