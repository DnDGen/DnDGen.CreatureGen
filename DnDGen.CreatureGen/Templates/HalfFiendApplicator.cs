    ...
    internal class HalfFiendApplicator : TemplateApplicator
    {
        ...
        public Creature ApplyTo(Creature creature, bool asCharacter, string type = null, string challengeRating = null, string alignment = null)
        {
            if (!IsCompatible(
                ...
                alignment))
            {
                throw new InvalidCreatureException(asCharacter, creature.Name, CreatureConstants.Templates.HalfFiend, type, challengeRating, alignment);
            }
            ...
            string alignment = null)
        {
            ...
            var templateCreatures = filteredBaseCreatures
                .Where(c => IsCompatible(allTypes[c], allAlignments[c], c, allData[c].ChallengeRating, allHitDice[c], asCharacter, type, challengeRating));
