...
namespace CreatureGen.Tests.Unit.Selectors.Collections
{
    ...
    public class AttackSelectorTests
    {
        ...
        private string GetData(string name, string damage, bool isNatural = false, bool isMelee = false, bool isPrimary = false, bool isSpecial = false)
        {
            ...
            data[DataIndexConstants.AttackData.Damage] = damage;
            data[DataIndexConstants.AttackData.IsMelee] = isMelee.ToString();
            data[DataIndexConstants.AttackData.IsNatural] = isNatural.ToString();
            data[DataIndexConstants.AttackData.IsPrimary] = isPrimary.ToString();
            data[DataIndexConstants.AttackData.IsSpecial] = isSpecial.ToString();
            data[DataIndexConstants.AttackData.Name] = name;
